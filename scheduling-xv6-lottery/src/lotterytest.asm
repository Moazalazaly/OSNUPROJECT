...
int main(int argc, char *argv[]) {
  ...
  1b:	c7 45 e0 14 00 00 00 	movl   $0x14,-0x20(%ebp)
  22:	c7 45 e4 1e 00 00 00 	movl   $0x1e,-0x1c(%ebp)

    for (i = 0; i < 3; i++) {
        pid = fork();
  29:	e8 ed 02 00 00       	call   31b <fork>
        if (pid == 0) {
  2e:	85 c0                	test   %eax,%eax
  30:	74 41                	je     73 <main+0x73>
        pid = fork();
  32:	e8 e4 02 00 00       	call   31b <fork>
        if (pid == 0) {
  37:	85 c0                	test   %eax,%eax
  39:	74 33                	je     6e <main+0x6e>
        pid = fork();
  3b:	e8 db 02 00 00       	call   31b <fork>
        if (pid == 0) {
  40:	85 c0                	test   %eax,%eax
  42:	0f 84 8a 00 00 00    	je     d2 <main+0xd2>
  ...
  4f:	00 
    ...
    while (wait() != -1);
  50:	e8 d6 02 00 00       	call   32b <wait>
  55:	83 f8 ff             	cmp    $0xffffffff,%eax
  58:	75 f6                	jne    50 <main+0x50>
    printf(1, "Test Complete\n");
  5a:	83 ec 08             	sub    $0x8,%esp
  5d:	68 ae 07 00 00       	push   $0x7ae
  62:	6a 01                	push   $0x1
  64:	e8 17 04 00 00       	call   480 <printf>
    exit();
  69:	e8 b5 02 00 00       	call   323 <exit>
    for (i = 0; i < 3; i++) {
  6e:	b8 01 00 00 00       	mov    $0x1,%eax
            settickets(tickets[i]);
  73:	8b 5c 85 dc          	mov    -0x24(%ebp,%eax,4),%ebx
  77:	83 ec 0c             	sub    $0xc,%esp
  7a:	53                   	push   %ebx
  7b:	e8 43 03 00 00       	call   3c3 <settickets>
            int start = uptime();
  80:	e8 36 03 00 00       	call   3bb <uptime>
  ...
  af:	29 f0                	sub    %esi,%eax
  b1:	89 c7                	mov    %eax,%edi
            printf(1, "RESULT: pid=%d tickets=%d runtime=%d\n", getpid(), tickets[i], runtime);
  b3:	e8 eb 02 00 00       	call   3a3 <getpid>
  b8:	83 ec 0c             	sub    $0xc,%esp
  bb:	57                   	push   %edi
  bc:	53                   	push   %ebx
  bd:	50                   	push   %eax
  be:	68 88 07 00 00       	push   $0x788
  c3:	6a 01                	push   $0x1
  c5:	e8 b6 03 00 00       	call   480 <printf>
            exit();
  ca:	83 c4 20             	add    $0x20,%esp
  cd:	e8 51 02 00 00       	call   323 <exit>
  d2:	b8 02 00 00 00       	mov    $0x2,%eax
  d7:	eb 9a                	jmp    73 <main+0x73>
  d9:	66 90                	xchg   %ax,%ax
  db:	66 90                	xchg   %ax,%ax
  dd:	66 90                	xchg   %ax,%ax
  df:	90                   	nop
 ...
 489:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 600:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 605:	bb bd 07 00 00       	mov    $0x7bd,%ebx
...
free(void *ap)
{
 ...
 611:	a1 c4 0a 00 00       	mov    0xac4,%eax
{
 ...
 64f:	5b                   	pop    %ebx
  freep = p;
 650:	a3 c4 0a 00 00       	mov    %eax,0xac4
}
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
 657:	5d                   	pop    %ebp
 ...
 666:	72 ce                	jb     636 <free+0x26>
{
 ...
 687:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 68a:	a3 c4 0a 00 00       	mov    %eax,0xac4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 15 c4 0a 00 00    	mov    0xac4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6eb:	3b 05 c4 0a 00 00    	cmp    0xac4,%eax
 ...
 70e:	e8 fd fe ff ff       	call   610 <free>
  return freep;
 713:	8b 15 c4 0a 00 00    	mov    0xac4,%edx
 ...
 73c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 73f:	89 15 c4 0a 00 00    	mov    %edx,0xac4
}
 ...
 74f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 750:	c7 05 c4 0a 00 00 c8 	movl   $0xac8,0xac4
 757:	0a 00 00 
    base.s.size = 0;
 75a:	b8 c8 0a 00 00       	mov    $0xac8,%eax
    base.s.ptr = freep = prevp = &base;
 75f:	c7 05 c8 0a 00 00 c8 	movl   $0xac8,0xac8
 766:	0a 00 00 
    base.s.size = 0;
 769:	c7 05 cc 0a 00 00 00 	movl   $0x0,0xacc
 770:	00 00 00 
    if(p->s.size >= nunits){
