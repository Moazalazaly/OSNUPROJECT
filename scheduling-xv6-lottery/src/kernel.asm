...
80100268:	5d                   	pop    %ebp
  release(&bcache.lock);
80100269:	e9 e2 43 00 00       	jmp    80104650 <release>
    panic("brelse");
8010026e:	83 ec 0c             	sub    $0xc,%esp
80100271:	68 46 73 10 80       	push   $0x80107346
...
801003b0:	e8 fb 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 cf 77 10 80 	movl   $0x801077cf,(%esp)
...
801005a3:	68 65 73 10 80       	push   $0x80107365
...
801005cb:	e8 e0 40 00 00       	call   801046b0 <acquire>
  for(i = 0; i < n; i++)
...
80100604:	e8 47 40 00 00       	call   80104650 <release>
  ilock(ip);
80100609:	58                   	pop    %eax
...
8010064b:	0f b6 92 20 78 10 80 	movzbl -0x7fef87e0(%edx),%edx
...
801007d8:	e8 d3 3e 00 00       	call   801046b0 <acquire>
  if (fmt == 0)
...
801007fb:	e8 50 3e 00 00       	call   80104650 <release>
...
80100838:	b9 28 00 00 00       	mov    $0x28,%ecx
        s = "(null)";
8010083d:	bf 78 73 10 80       	mov    $0x80107378,%edi
...
8010088c:	68 7f 73 10 80       	push   $0x8010737f
...
801008b3:	e8 f8 3d 00 00       	call   801046b0 <acquire>
  while((c = getc()) >= 0){
...
801008ed:	e8 5e 3d 00 00       	call   80104650 <release>
  if(doprocdump) {
...
80100cca:	e8 d1 3c 00 00       	call   801049a0 <strlen>
...
80100e1a:	68 90 73 10 80       	push   $0x80107390
...
80100e36:	68 9c 73 10 80       	push   $0x8010739c
80100e3b:	68 60 ef 10 80       	push   $0x8010ef60
80100e40:	e8 7b 36 00 00       	call   801044c0 <initlock>
}
...
80100e61:	e8 4a 38 00 00       	call   801046b0 <acquire>
...
80100e91:	e8 ba 37 00 00       	call   80104650 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100eaa:	e8 a1 37 00 00       	call   80104650 <release>
}
...
80100ecf:	e8 dc 37 00 00       	call   801046b0 <acquire>
  if(f->ref < 1)
...
80100eec:	e8 5f 37 00 00       	call   80104650 <release>
  return f;
}
...
80100efb:	68 a3 73 10 80       	push   $0x801073a3
...
80100f21:	e8 8a 37 00 00       	call   801046b0 <acquire>
  if(f->ref < 1)
...
80100f5c:	e8 ef 36 00 00       	call   80104650 <release>
...
80100f8d:	5d                   	pop    %ebp
    release(&ftable.lock);
80100f8e:	e9 bd 36 00 00       	jmp    80104650 <release>
...
80100fdc:	68 ab 73 10 80       	push   $0x801073ab
...
801010c2:	68 b5 73 10 80       	push   $0x801073b5
...
80101197:	68 be 73 10 80       	push   $0x801073be
...
801011d1:	68 c4 73 10 80       	push   $0x801073c4
...
80101289:	68 ce 73 10 80       	push   $0x801073ce
...
801012cd:	e8 de 34 00 00       	call   801047b0 <memset>
  log_write(bp);
...
8010130a:	e8 a1 33 00 00       	call   801046b0 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
80101377:	e8 d4 32 00 00       	call   80104650 <release>
...
801013a5:	e8 a6 32 00 00       	call   80104650 <release>
      return ip;
...
801013d8:	68 e4 73 10 80       	push   $0x801073e4
...
80101457:	68 f4 73 10 80       	push   $0x801073f4
...
80101535:	68 07 74 10 80       	push   $0x80107407
...
80101561:	e8 da 32 00 00       	call   80104840 <memmove>
  brelse(bp);
...
8010158c:	68 1a 74 10 80       	push   $0x8010741a
80101591:	68 60 f9 10 80       	push   $0x8010f960
80101596:	e8 25 2f 00 00       	call   801044c0 <initlock>
  for(i = 0; i < NINODE; i++) {
8010159b:	83 c4 10             	add    $0x10,%esp
8010159e:	66 90                	xchg   %ax,%ax
    initsleeplock(&icache.inode[i].lock, "inode");
801015a0:	83 ec 08             	sub    $0x8,%esp
801015a3:	68 21 74 10 80       	push   $0x80107421
801015a8:	53                   	push   %ebx
  for(i = 0; i < NINODE; i++) {
801015a9:	81 c3 90 00 00 00    	add    $0x90,%ebx
    initsleeplock(&icache.inode[i].lock, "inode");
801015af:	e8 dc 2d 00 00       	call   80104390 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015dc:	e8 5f 32 00 00       	call   80104840 <memmove>
  brelse(bp);
...
80101613:	68 34 78 10 80       	push   $0x80107834
...
801016ae:	e8 fd 30 00 00       	call   801047b0 <memset>
      dip->type = type;
...
801016e3:	68 27 74 10 80       	push   $0x80107427
...
80101751:	e8 ea 30 00 00       	call   80104840 <memmove>
  log_write(bp);
...
8010177f:	e8 2c 2f 00 00       	call   801046b0 <acquire>
  ip->ref++;
80101784:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101788:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
8010178f:	e8 bc 2e 00 00       	call   80104650 <release>
}
...
801017c2:	e8 09 2c 00 00       	call   801043d0 <acquiresleep>
  if(ip->valid == 0){
...
80101838:	e8 03 30 00 00       	call   80104840 <memmove>
    brelse(bp);
...
8010185d:	68 3f 74 10 80       	push   $0x8010743f
80101862:	e8 19 eb ff ff       	call   80100380 <panic>
    panic("ilock");
80101867:	83 ec 0c             	sub    $0xc,%esp
8010186a:	68 39 74 10 80       	push   $0x80107439
...
80101893:	e8 d8 2b 00 00       	call   80104470 <holdingsleep>
...
801018ae:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
801018af:	e9 7c 2b 00 00       	jmp    80104430 <releasesleep>
    panic("iunlock");
801018b4:	83 ec 0c             	sub    $0xc,%esp
801018b7:	68 4e 74 10 80       	push   $0x8010744e
...
801018e0:	e8 eb 2a 00 00       	call   801043d0 <acquiresleep>
...
801018fa:	e8 31 2b 00 00       	call   80104430 <releasesleep>
  acquire(&icache.lock);
801018ff:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
80101906:	e8 a5 2d 00 00       	call   801046b0 <acquire>
  ip->ref--;
...
80101a43:	e8 28 2a 00 00       	call   80104470 <holdingsleep>
...
80101a5a:	e8 d1 29 00 00       	call   80104430 <releasesleep>
  iput(ip);
...
80101a73:	68 4e 74 10 80       	push   $0x8010744e
...
80101b57:	e8 e4 2c 00 00       	call   80104840 <memmove>
    brelse(bp);
...
80101c55:	e8 e6 2b 00 00       	call   80104840 <memmove>
    log_write(bp);
...
80101d82:	68 68 74 10 80       	push   $0x80107468
80101d87:	e8 f4 e5 ff ff       	call   80100380 <panic>
    panic("dirlookup not DIR");
80101d8c:	83 ec 0c             	sub    $0xc,%esp
80101d8f:	68 56 74 10 80       	push   $0x80107456
...
80101dca:	e8 e1 28 00 00       	call   801046b0 <acquire>
  ip->ref++;
80101dcf:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101dd3:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
80101dda:	e8 71 28 00 00       	call   80104650 <release>
...
80101e9c:	e8 cf 25 00 00       	call   80104470 <holdingsleep>
...
80101ebe:	e8 6d 25 00 00       	call   80104430 <releasesleep>
  iput(ip);
...
80101f25:	e8 46 25 00 00       	call   80104470 <holdingsleep>
...
80101f3c:	e8 ef 24 00 00       	call   80104430 <releasesleep>
  iput(ip);
...
80101f75:	e8 f6 24 00 00       	call   80104470 <holdingsleep>
...
80101f8c:	e8 9f 24 00 00       	call   80104430 <releasesleep>
}
...
80101fb1:	68 4e 74 10 80       	push   $0x8010744e
...
8010201d:	e8 de 28 00 00       	call   80104900 <strncpy>
  de.inum = inum;
...
8010205b:	68 77 74 10 80       	push   $0x80107477
80102060:	e8 1b e3 ff ff       	call   80100380 <panic>
    panic("dirlink");
80102065:	83 ec 0c             	sub    $0xc,%esp
80102068:	68 d3 76 10 80       	push   $0x801076d3
...
8010217b:	68 8d 74 10 80       	push   $0x8010748d
80102180:	e8 fb e1 ff ff       	call   80100380 <panic>
    panic("idestart");
80102185:	83 ec 0c             	sub    $0xc,%esp
80102188:	68 84 74 10 80       	push   $0x80107484
...
801021a6:	68 9f 74 10 80       	push   $0x8010749f
801021ab:	68 00 16 11 80       	push   $0x80111600
801021b0:	e8 0b 23 00 00       	call   801044c0 <initlock>
...
8010223e:	e8 6d 24 00 00       	call   801046b0 <acquire>
...
801022bb:	e8 90 23 00 00       	call   80104650 <release>
...
801022de:	e8 8d 21 00 00       	call   80104470 <holdingsleep>
...
80102318:	e8 93 23 00 00       	call   801046b0 <acquire>
...
80102375:	c9                   	leave
  release(&idelock);
80102376:	e9 d5 22 00 00       	jmp    80104650 <release>
...
8010240a:	68 88 78 10 80       	push   $0x80107888
...
801024d2:	e8 d9 22 00 00       	call   801047b0 <memset>
...
80102508:	e8 a3 21 00 00       	call   801046b0 <acquire>
...
80102522:	c9                   	leave
    release(&kmem.lock);
80102523:	e9 28 21 00 00       	jmp    80104650 <release>
    panic("kfree");
80102528:	83 ec 0c             	sub    $0xc,%esp
8010252b:	68 ec 74 10 80       	push   $0x801074ec
...
801025fb:	68 f2 74 10 80       	push   $0x801074f2
80102600:	68 40 16 11 80       	push   $0x80111640
80102605:	e8 b6 1e 00 00       	call   801044c0 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
80102698:	e8 13 20 00 00       	call   801046b0 <acquire>
  r = kmem.freelist;
...
801026c3:	e8 88 1f 00 00       	call   80104650 <release>
}
...
80102ad3:	e8 18 1d 00 00       	call   801047f0 <memcmp>
...
80102c04:	e8 37 1c 00 00       	call   80104840 <memmove>
...
80102caa:	68 f7 74 10 80       	push   $0x801074f7
80102caf:	68 a0 16 11 80       	push   $0x801116a0
80102cb4:	e8 07 18 00 00       	call   801044c0 <initlock>
  readsb(dev, &sb);
80102cb9:	58                   	pop    %eax
...
80102d4b:	e8 60 19 00 00       	call   801046b0 <acquire>
...
80102d65:	e8 36 13 00 00       	call   801040a0 <sleep>
...
80102d9c:	e8 af 18 00 00       	call   80104650 <release>
      break;
    }
  }
}
...
80102dbe:	e8 ed 18 00 00       	call   801046b0 <acquire>
  log.outstanding -= 1;
...
80102dfc:	e8 4f 18 00 00       	call   80104650 <release>
}
...
80102e94:	e8 a7 19 00 00       	call   80104840 <memmove>
...
80102ee8:	e8 73 12 00 00       	call   80104160 <wakeup>
  release(&log.lock);
80102eed:	c7 04 24 a0 16 11 80 	movl   $0x801116a0,(%esp)
80102ef4:	e8 57 17 00 00       	call   80104650 <release>
...
80102f07:	68 fb 74 10 80       	push   $0x801074fb
...
80102f98:	c9                   	leave
  release(&log.lock);
80102f99:	e9 b2 16 00 00       	jmp    80104650 <release>
...
80102fb5:	68 0a 75 10 80       	push   $0x8010750a
80102fba:	e8 c1 d3 ff ff       	call   80100380 <panic>
    panic("log_write outside of trans");
80102fbf:	83 ec 0c             	sub    $0xc,%esp
80102fc2:	68 20 75 10 80       	push   $0x80107520
...
80102fe8:	68 3b 75 10 80       	push   $0x8010753b
80102fed:	e8 be d6 ff ff       	call   801006b0 <cprintf>
  idtinit();       // load idt register
80102ff2:	e8 79 2a 00 00       	call   80105a70 <idtinit>
...
80103013:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103016:	e8 55 3b 00 00       	call   80106b70 <switchkvm>
  seginit();
8010301b:	e8 c0 3a 00 00       	call   80106ae0 <seginit>
  lapicinit();
...
80103074:	e8 d7 2c 00 00       	call   80105d50 <uartinit>
  pinit();         // process table
80103079:	e8 52 08 00 00       	call   801038d0 <pinit>
  tvinit();        // trap vectors
8010307e:	e8 6d 29 00 00       	call   801059f0 <tvinit>
  binit();         // buffer cache
...
8010309a:	68 90 a4 10 80       	push   $0x8010a490
8010309f:	68 00 70 00 80       	push   $0x80007000
801030a4:	e8 97 17 00 00       	call   80104840 <memmove>
...
8010318e:	68 4f 75 10 80       	push   $0x8010754f
80103193:	56                   	push   %esi
80103194:	e8 57 16 00 00       	call   801047f0 <memcmp>
...
80103249:	68 54 75 10 80       	push   $0x80107554
8010324e:	50                   	push   %eax
8010324f:	e8 9c 15 00 00       	call   801047f0 <memcmp>
...
8010337b:	68 59 75 10 80       	push   $0x80107559
...
801033a2:	68 4f 75 10 80       	push   $0x8010754f
801033a7:	53                   	push   %ebx
801033a8:	e8 43 14 00 00       	call   801047f0 <memcmp>
...
801033d8:	68 bc 78 10 80       	push   $0x801078bc
...
80103480:	00 00 00 
  initlock(&p->lock, "pipe");
80103483:	68 71 75 10 80       	push   $0x80107571
80103488:	50                   	push   %eax
80103489:	e8 32 10 00 00       	call   801044c0 <initlock>
  (*f0)->type = FD_PIPE;
...
8010350f:	e8 9c 11 00 00       	call   801046b0 <acquire>
  if(writable){
...
8010352f:	e8 2c 0c 00 00       	call   80104160 <wakeup>
...
80103553:	5d                   	pop    %ebp
    release(&p->lock);
80103554:	e9 f7 10 00 00       	jmp    80104650 <release>
80103559:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    release(&p->lock);
80103560:	83 ec 0c             	sub    $0xc,%esp
80103563:	53                   	push   %ebx
80103564:	e8 e7 10 00 00       	call   80104650 <release>
    kfree((char*)p);
...
80103594:	e8 c7 0b 00 00       	call   80104160 <wakeup>
...
801035b0:	e8 fb 10 00 00       	call   801046b0 <acquire>
  for(i = 0; i < n; i++){
...
80103644:	e8 07 10 00 00       	call   80104650 <release>
        return -1;
...
80103698:	e8 c3 0a 00 00       	call   80104160 <wakeup>
  release(&p->lock);
8010369d:	89 1c 24             	mov    %ebx,(%esp)
801036a0:	e8 ab 0f 00 00       	call   80104650 <release>
  return n;
...
801036d6:	e8 d5 0f 00 00       	call   801046b0 <acquire>
...
801036f5:	8b 40 2c             	mov    0x2c(%eax),%eax
...
80103705:	e8 96 09 00 00       	call   801040a0 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
80103766:	e8 f5 09 00 00       	call   80104160 <wakeup>
  release(&p->lock);
...
80103789:	e8 c2 0e 00 00       	call   80104650 <release>
      return -1;
...
801037b1:	e8 fa 0e 00 00       	call   801046b0 <acquire>
...
801037cc:	0f 84 86 00 00 00    	je     80103858 <allocproc+0xb8>
    if(p->state == UNUSED)
801037d2:	8b 43 14             	mov    0x14(%ebx),%eax
...
801037de:	83 ec 0c             	sub    $0xc,%esp
  p->state = EMBRYO;
801037e1:	c7 43 14 01 00 00 00 	movl   $0x1,0x14(%ebx)
  p->tickets = 1 ;
801037e8:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
  p->pid = nextpid++;
801037ef:	89 43 18             	mov    %eax,0x18(%ebx)
801037f2:	8d 50 01             	lea    0x1(%eax),%edx
  p->ticks = 0 ;
801037f5:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  release(&ptable.lock);
801037fc:	68 20 1d 11 80       	push   $0x80111d20
  p->pid = nextpid++;
80103801:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103807:	e8 44 0e 00 00       	call   80104650 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
8010380c:	e8 4f ee ff ff       	call   80102660 <kalloc>
80103811:	83 c4 10             	add    $0x10,%esp
80103814:	89 43 10             	mov    %eax,0x10(%ebx)
80103817:	85 c0                	test   %eax,%eax
80103819:	74 56                	je     80103871 <allocproc+0xd1>
    return 0;
  }
  ...
  sp -= sizeof *p->tf;
8010381b:	8d 90 b4 0f 00 00    	lea    0xfb4(%eax),%edx
  sp -= 4;
...
80103821:	83 ec 04             	sub    $0x4,%esp
  sp -= sizeof *p->context;
80103824:	05 9c 0f 00 00       	add    $0xf9c,%eax
  sp -= sizeof *p->tf;
80103829:	89 53 20             	mov    %edx,0x20(%ebx)
  *(uint*)sp = (uint)trapret;
8010382c:	c7 40 14 df 59 10 80 	movl   $0x801059df,0x14(%eax)
  p->context = (struct context*)sp;
80103833:	89 43 24             	mov    %eax,0x24(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103836:	6a 14                	push   $0x14
80103838:	6a 00                	push   $0x0
8010383a:	50                   	push   %eax
8010383b:	e8 70 0f 00 00       	call   801047b0 <memset>
...
80103843:	83 c4 10             	add    $0x10,%esp
  p->context->eip = (uint)forkret;
80103846:	c7 40 10 80 38 10 80 	movl   $0x80103880,0x10(%eax)
}
8010384d:	89 d8                	mov    %ebx,%eax
...
80103862:	e8 e9 0d 00 00       	call   80104650 <release>
  return 0;
...
8010387a:	eb ee                	jmp    8010386a <allocproc+0xca>
...
801038d6:	68 76 75 10 80       	push   $0x80107576
...
801039ac:	89 c3                	mov    %eax,%ebx
  initproc = p;
801039ae:	a3 54 3e 11 80       	mov    %eax,0x80113e54
  if((p->pgdir = setupkvm()) == 0)
801039b3:	e8 f8 35 00 00       	call   80106fb0 <setupkvm>
801039b8:	89 43 0c             	mov    %eax,0xc(%ebx)
...
801039cb:	68 64 a4 10 80       	push   $0x8010a464
801039d0:	50                   	push   %eax
801039d1:	e8 ba 32 00 00       	call   80106c90 <inituvm>
...
801039e3:	ff 73 20             	push   0x20(%ebx)
801039e6:	e8 c5 0d 00 00       	call   801047b0 <memset>
...
80103a30:	8b 43 20             	mov    0x20(%ebx),%eax
80103a33:	c7 40 38 00 00 00 00 	movl   $0x0,0x38(%eax)
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103a3a:	8d 43 74             	lea    0x74(%ebx),%eax
80103a3d:	6a 10                	push   $0x10
80103a3f:	68 a6 75 10 80       	push   $0x801075a6
80103a44:	50                   	push   %eax
80103a45:	e8 16 0f 00 00       	call   80104960 <safestrcpy>
  p->cwd = namei("/");
80103a4a:	c7 04 24 af 75 10 80 	movl   $0x801075af,(%esp)
80103a51:	e8 2a e6 ff ff       	call   80102080 <namei>
80103a56:	89 43 70             	mov    %eax,0x70(%ebx)
  acquire(&ptable.lock);
80103a59:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103a60:	e8 4b 0c 00 00       	call   801046b0 <acquire>
  p->state = RUNNABLE;
80103a65:	c7 43 14 03 00 00 00 	movl   $0x3,0x14(%ebx)
  release(&ptable.lock);
...
80103a83:	68 8d 75 10 80       	push   $0x8010758d
...
80103a95:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103a98:	e8 c3 0a 00 00       	call   80104560 <pushcli>
  c = mycpu();
80103a9d:	e8 4e fe ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103aa2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103aa8:	e8 03 0b 00 00       	call   801045b0 <popcli>
  sz = curproc->sz;
...
80103abb:	e8 c0 30 00 00       	call   80106b80 <switchuvm>
  return 0;
...
80103ad7:	ff 73 0c             	push   0xc(%ebx)
...
80103af7:	ff 73 0c             	push   0xc(%ebx)
...
80103b16:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b19:	e8 42 0a 00 00       	call   80104560 <pushcli>
  c = mycpu();
80103b1e:	e8 cd fd ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103b23:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b29:	e8 82 0a 00 00       	call   801045b0 <popcli>
  if((np = allocproc()) == 0){
80103b2e:	e8 6d fc ff ff       	call   801037a0 <allocproc>
80103b33:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80103b36:	85 c0                	test   %eax,%eax
80103b38:	0f 84 ee 00 00 00    	je     80103c2c <fork+0x11c>
  if((np->pgdir = copyuvm(curproc->pgdir, curproc->sz)) == 0){
80103b3e:	83 ec 08             	sub    $0x8,%esp
80103b41:	ff 33                	push   (%ebx)
80103b43:	89 c7                	mov    %eax,%edi
80103b45:	ff 73 0c             	push   0xc(%ebx)
80103b48:	e8 53 35 00 00       	call   801070a0 <copyuvm>
80103b4d:	83 c4 10             	add    $0x10,%esp
80103b50:	89 47 0c             	mov    %eax,0xc(%edi)
80103b53:	85 c0                	test   %eax,%eax
80103b55:	0f 84 b2 00 00 00    	je     80103c0d <fork+0xfd>
  np->sz = curproc->sz;
80103b5b:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80103b5e:	8b 03                	mov    (%ebx),%eax
  if (np->pid != 1) {
80103b60:	83 79 18 01          	cmpl   $0x1,0x18(%ecx)
  np->sz = curproc->sz;
80103b64:	89 01                	mov    %eax,(%ecx)
    np->tickets = 1 ;  
80103b66:	b8 01 00 00 00       	mov    $0x1,%eax
  np->parent = curproc;
80103b6b:	89 59 1c             	mov    %ebx,0x1c(%ecx)
  if (np->pid != 1) {
80103b6e:	74 03                	je     80103b73 <fork+0x63>
    np->tickets = curproc->tickets ;
80103b70:	8b 43 04             	mov    0x4(%ebx),%eax
80103b73:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80103b76:	89 41 04             	mov    %eax,0x4(%ecx)
  *np->tf = *curproc->tf;
80103b79:	8b 79 20             	mov    0x20(%ecx),%edi
80103b7c:	89 c8                	mov    %ecx,%eax
80103b7e:	b9 13 00 00 00       	mov    $0x13,%ecx
80103b83:	8b 73 20             	mov    0x20(%ebx),%esi
80103b86:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  for(i = 0; i < NOFILE; i++)
80103b88:	31 f6                	xor    %esi,%esi
  np->tf->eax = 0;
80103b8a:	8b 40 20             	mov    0x20(%eax),%eax
80103b8d:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
  for(i = 0; i < NOFILE; i++)
80103b94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[i])
80103b98:	8b 44 b3 30          	mov    0x30(%ebx,%esi,4),%eax
80103b9c:	85 c0                	test   %eax,%eax
80103b9e:	74 13                	je     80103bb3 <fork+0xa3>
      np->ofile[i] = filedup(curproc->ofile[i]);
80103ba0:	83 ec 0c             	sub    $0xc,%esp
80103ba3:	50                   	push   %eax
80103ba4:	e8 17 d3 ff ff       	call   80100ec0 <filedup>
80103ba9:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80103bac:	83 c4 10             	add    $0x10,%esp
80103baf:	89 44 b2 30          	mov    %eax,0x30(%edx,%esi,4)
  for(i = 0; i < NOFILE; i++)
80103bb3:	83 c6 01             	add    $0x1,%esi
80103bb6:	83 fe 10             	cmp    $0x10,%esi
80103bb9:	75 dd                	jne    80103b98 <fork+0x88>
  np->cwd = idup(curproc->cwd);
80103bbb:	83 ec 0c             	sub    $0xc,%esp
80103bbe:	ff 73 70             	push   0x70(%ebx)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103bc1:	83 c3 74             	add    $0x74,%ebx
  np->cwd = idup(curproc->cwd);
80103bc4:	e8 a7 db ff ff       	call   80101770 <idup>
80103bc9:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103bcc:	83 c4 0c             	add    $0xc,%esp
  np->cwd = idup(curproc->cwd);
80103bcf:	89 47 70             	mov    %eax,0x70(%edi)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103bd2:	8d 47 74             	lea    0x74(%edi),%eax
80103bd5:	6a 10                	push   $0x10
80103bd7:	53                   	push   %ebx
80103bd8:	50                   	push   %eax
80103bd9:	e8 82 0d 00 00       	call   80104960 <safestrcpy>
  pid = np->pid;
80103bde:	8b 5f 18             	mov    0x18(%edi),%ebx
  acquire(&ptable.lock);
80103be1:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103be8:	e8 c3 0a 00 00       	call   801046b0 <acquire>
  np->state = RUNNABLE;
80103bed:	c7 47 14 03 00 00 00 	movl   $0x3,0x14(%edi)
  release(&ptable.lock);
...
80103c0c:	c3                   	ret
    kfree(np->kstack);
80103c0d:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80103c10:	83 ec 0c             	sub    $0xc,%esp
80103c13:	ff 73 10             	push   0x10(%ebx)
80103c16:	e8 85 e8 ff ff       	call   801024a0 <kfree>
    np->kstack = 0;
80103c1b:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
    return -1;
80103c22:	83 c4 10             	add    $0x10,%esp
    np->state = UNUSED;
80103c25:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
    return -1;
80103c2c:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80103c31:	eb d0                	jmp    80103c03 <fork+0xf3>
80103c33:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80103c3a:	00 
...
80103c46:	83 ec 1c             	sub    $0x1c,%esp
  struct cpu *c = mycpu();
80103c49:	e8 a2 fc ff ff       	call   801038f0 <mycpu>
  c->proc = 0;
...
80103c64:	68 20 1d 11 80       	push   $0x80111d20
80103c69:	e8 42 0a 00 00       	call   801046b0 <acquire>
...
80103c7f:	00 
      if(p->state == RUNNABLE)
80103c80:	83 78 14 03          	cmpl   $0x3,0x14(%eax)
80103c84:	75 03                	jne    80103c89 <scheduler+0x49>
        totalTickets += p->tickets ;
80103c86:	03 50 04             	add    0x4(%eax),%edx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103c89:	05 84 00 00 00       	add    $0x84,%eax
80103c8e:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
80103c93:	75 eb                	jne    80103c80 <scheduler+0x40>
    uint winner = getRandomNumber(0, totalTickets);
...
80103ca0:	e8 4b 36 00 00       	call   801072f0 <getRandomNumber>
80103ca5:	83 c4 10             	add    $0x10,%esp
    uint counter = 0 ;
80103ca8:	31 d2                	xor    %edx,%edx
      if(p->state != RUNNABLE)
80103caa:	83 7f 14 03          	cmpl   $0x3,0x14(%edi)
80103cae:	75 68                	jne    80103d18 <scheduler+0xd8>
      counter += p->tickets ;
80103cb0:	03 57 04             	add    0x4(%edi),%edx
      if(counter <= winner)
80103cb3:	39 d0                	cmp    %edx,%eax
80103cb5:	73 61                	jae    80103d18 <scheduler+0xd8>
      switchuvm(p);
80103cb7:	83 ec 0c             	sub    $0xc,%esp
      c->proc = p;
80103cba:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
      switchuvm(p);
80103cc0:	57                   	push   %edi
80103cc1:	e8 ba 2e 00 00       	call   80106b80 <switchuvm>
      swtch(&(c->scheduler), p->context);
80103cc6:	58                   	pop    %eax
80103cc7:	5a                   	pop    %edx
80103cc8:	ff 77 24             	push   0x24(%edi)
      const int start_ticks = ticks ;
80103ccb:	8b 35 60 3e 11 80    	mov    0x80113e60,%esi
      swtch(&(c->scheduler), p->context);
80103cd1:	ff 75 e4             	push   -0x1c(%ebp)
      p->state = RUNNING;
80103cd4:	c7 47 14 04 00 00 00 	movl   $0x4,0x14(%edi)
      swtch(&(c->scheduler), p->context);
80103cdb:	e8 db 0c 00 00       	call   801049bb <swtch>
      p->ticks+= ticks - start_ticks ;
80103ce0:	a1 60 3e 11 80       	mov    0x80113e60,%eax
80103ce5:	29 f0                	sub    %esi,%eax
80103ce7:	01 47 08             	add    %eax,0x8(%edi)
      switchkvm();
80103cea:	e8 81 2e 00 00       	call   80106b70 <switchkvm>
      break;
...
80103cff:	68 20 1d 11 80       	push   $0x80111d20
80103d04:	e8 47 09 00 00       	call   80104650 <release>
  for(;;){
80103d09:	83 c4 10             	add    $0x10,%esp
80103d0c:	e9 4f ff ff ff       	jmp    80103c60 <scheduler+0x20>
80103d11:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d18:	81 c7 84 00 00 00    	add    $0x84,%edi
80103d1e:	81 ff 54 3e 11 80    	cmp    $0x80113e54,%edi
80103d24:	75 84                	jne    80103caa <scheduler+0x6a>
80103d26:	eb d4                	jmp    80103cfc <scheduler+0xbc>
80103d28:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80103d2f:	00 
...
80103d34:	53                   	push   %ebx
  pushcli();
80103d35:	e8 26 08 00 00       	call   80104560 <pushcli>
  c = mycpu();
80103d3a:	e8 b1 fb ff ff       	call   801038f0 <mycpu>
  p = c->proc;
...
80103d7e:	83 c3 24             	add    $0x24,%ebx
  intena = mycpu()->intena;
80103d81:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103d87:	e8 64 fb ff ff       	call   801038f0 <mycpu>
80103d8c:	83 ec 08             	sub    $0x8,%esp
80103d8f:	ff 70 04             	push   0x4(%eax)
80103d92:	53                   	push   %ebx
80103d93:	e8 23 0c 00 00       	call   801049bb <swtch>
  mycpu()->intena = intena;
80103d98:	e8 53 fb ff ff       	call   801038f0 <mycpu>
}
...
80103df6:	83 ec 0c             	sub    $0xc,%esp
  struct proc *curproc = myproc();
80103df9:	e8 72 fb ff ff       	call   80103970 <myproc>
  if(curproc == initproc)
80103dfe:	39 05 54 3e 11 80    	cmp    %eax,0x80113e54
80103e04:	0f 84 07 01 00 00    	je     80103f11 <exit+0x121>
80103e0a:	89 c3                	mov    %eax,%ebx
80103e0c:	8d 70 30             	lea    0x30(%eax),%esi
80103e0f:	8d 78 70             	lea    0x70(%eax),%edi
...
80103e35:	75 e1                	jne    80103e18 <exit+0x28>
  begin_op();
80103e37:	e8 04 ef ff ff       	call   80102d40 <begin_op>
  iput(curproc->cwd);
80103e3c:	83 ec 0c             	sub    $0xc,%esp
80103e3f:	ff 73 70             	push   0x70(%ebx)
80103e42:	e8 89 da ff ff       	call   801018d0 <iput>
  end_op();
80103e47:	e8 64 ef ff ff       	call   80102db0 <end_op>
  curproc->cwd = 0;
80103e4c:	c7 43 70 00 00 00 00 	movl   $0x0,0x70(%ebx)
  acquire(&ptable.lock);
80103e53:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103e5a:	e8 51 08 00 00       	call   801046b0 <acquire>
  wakeup1(curproc->parent);
80103e5f:	8b 53 1c             	mov    0x1c(%ebx),%edx
...
80103e75:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
80103e7a:	74 1e                	je     80103e9a <exit+0xaa>
    if(p->state == SLEEPING && p->chan == chan)
80103e7c:	83 78 14 02          	cmpl   $0x2,0x14(%eax)
80103e80:	75 ee                	jne    80103e70 <exit+0x80>
80103e82:	3b 50 28             	cmp    0x28(%eax),%edx
80103e85:	75 e9                	jne    80103e70 <exit+0x80>
      p->state = RUNNABLE;
80103e87:	c7 40 14 03 00 00 00 	movl   $0x3,0x14(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e8e:	05 84 00 00 00       	add    $0x84,%eax
80103e93:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
80103e98:	75 e2                	jne    80103e7c <exit+0x8c>
      p->parent = initproc;
80103e9a:	8b 0d 54 3e 11 80    	mov    0x80113e54,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ea0:	ba 54 1d 11 80       	mov    $0x80111d54,%edx
...
80103eb6:	81 fa 54 3e 11 80    	cmp    $0x80113e54,%edx
80103ebc:	74 3a                	je     80103ef8 <exit+0x108>
    if(p->parent == curproc){
80103ebe:	39 5a 1c             	cmp    %ebx,0x1c(%edx)
80103ec1:	75 ed                	jne    80103eb0 <exit+0xc0>
      if(p->state == ZOMBIE)
80103ec3:	83 7a 14 05          	cmpl   $0x5,0x14(%edx)
      p->parent = initproc;
80103ec7:	89 4a 1c             	mov    %ecx,0x1c(%edx)
      if(p->state == ZOMBIE)
80103eca:	75 e4                	jne    80103eb0 <exit+0xc0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103ecc:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
...
80103f2f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103f35:	e8 76 06 00 00       	call   801045b0 <popcli>
  acquire(&ptable.lock);
80103f3a:	83 ec 0c             	sub    $0xc,%esp
80103f3d:	68 20 1d 11 80       	push   $0x80111d20
80103f42:	e8 69 07 00 00       	call   801046b0 <acquire>
...
80103f58:	81 c3 84 00 00 00    	add    $0x84,%ebx
80103f5e:	81 fb 54 3e 11 80    	cmp    $0x80113e54,%ebx
80103f64:	74 1e                	je     80103f84 <wait+0x64>
      if(p->parent != curproc)
80103f66:	39 73 1c             	cmp    %esi,0x1c(%ebx)
80103f69:	75 ed                	jne    80103f58 <wait+0x38>
      if(p->state == ZOMBIE){
80103f6b:	83 7b 14 05          	cmpl   $0x5,0x14(%ebx)
80103f6f:	74 5f                	je     80103fd0 <wait+0xb0>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f71:	81 c3 84 00 00 00    	add    $0x84,%ebx
      havekids = 1;
80103f77:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f7c:	81 fb 54 3e 11 80    	cmp    $0x80113e54,%ebx
80103f82:	75 e2                	jne    80103f66 <wait+0x46>
    if(!havekids || curproc->killed){
80103f84:	85 c0                	test   %eax,%eax
80103f86:	0f 84 9a 00 00 00    	je     80104026 <wait+0x106>
80103f8c:	8b 46 2c             	mov    0x2c(%esi),%eax
80103f8f:	85 c0                	test   %eax,%eax
80103f91:	0f 85 8f 00 00 00    	jne    80104026 <wait+0x106>
  pushcli();
80103f97:	e8 c4 05 00 00       	call   80104560 <pushcli>
  c = mycpu();
80103f9c:	e8 4f f9 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103fa1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103fa7:	e8 04 06 00 00       	call   801045b0 <popcli>
  if(p == 0)
80103fac:	85 db                	test   %ebx,%ebx
80103fae:	0f 84 89 00 00 00    	je     8010403d <wait+0x11d>
  p->chan = chan;
80103fb4:	89 73 28             	mov    %esi,0x28(%ebx)
  p->state = SLEEPING;
80103fb7:	c7 43 14 02 00 00 00 	movl   $0x2,0x14(%ebx)
  sched();
80103fbe:	e8 6d fd ff ff       	call   80103d30 <sched>
  p->chan = 0;
80103fc3:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
}
...
80103fd3:	8b 73 18             	mov    0x18(%ebx),%esi
        kfree(p->kstack);
80103fd6:	ff 73 10             	push   0x10(%ebx)
80103fd9:	e8 c2 e4 ff ff       	call   801024a0 <kfree>
        p->kstack = 0;
80103fde:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        freevm(p->pgdir);
80103fe5:	5a                   	pop    %edx
80103fe6:	ff 73 0c             	push   0xc(%ebx)
80103fe9:	e8 42 2f 00 00       	call   80106f30 <freevm>
        p->pid = 0;
80103fee:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
        p->parent = 0;
80103ff5:	c7 43 1c 00 00 00 00 	movl   $0x0,0x1c(%ebx)
        p->name[0] = 0;
80103ffc:	c6 43 74 00          	movb   $0x0,0x74(%ebx)
        p->killed = 0;
80104000:	c7 43 2c 00 00 00 00 	movl   $0x0,0x2c(%ebx)
        p->state = UNUSED;
80104007:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        release(&ptable.lock);
8010400e:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80104015:	e8 36 06 00 00       	call   80104650 <release>
        return pid;
...
8010405c:	e8 4f 06 00 00       	call   801046b0 <acquire>
  pushcli();
80104061:	e8 fa 04 00 00       	call   80104560 <pushcli>
  c = mycpu();
80104066:	e8 85 f8 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
8010406b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104071:	e8 3a 05 00 00       	call   801045b0 <popcli>
  myproc()->state = RUNNABLE;
80104076:	c7 43 14 03 00 00 00 	movl   $0x3,0x14(%ebx)
  sched();
8010407d:	e8 ae fc ff ff       	call   80103d30 <sched>
  release(&ptable.lock);
80104082:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80104089:	e8 c2 05 00 00       	call   80104650 <release>
}
...
801040ac:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
801040af:	e8 ac 04 00 00       	call   80104560 <pushcli>
  c = mycpu();
801040b4:	e8 37 f8 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
801040b9:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801040bf:	e8 ec 04 00 00       	call   801045b0 <popcli>
  if(p == 0)
...
801040e0:	e8 cb 05 00 00       	call   801046b0 <acquire>
    release(lk);
801040e5:	89 34 24             	mov    %esi,(%esp)
801040e8:	e8 63 05 00 00       	call   80104650 <release>
  p->chan = chan;
801040ed:	89 7b 28             	mov    %edi,0x28(%ebx)
  p->state = SLEEPING;
801040f0:	c7 43 14 02 00 00 00 	movl   $0x2,0x14(%ebx)
  sched();
801040f7:	e8 34 fc ff ff       	call   80103d30 <sched>
  p->chan = 0;
801040fc:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
    release(&ptable.lock);
80104103:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
8010410a:	e8 41 05 00 00       	call   80104650 <release>
    acquire(lk);
...
8010411b:	5d                   	pop    %ebp
    acquire(lk);
8010411c:	e9 8f 05 00 00       	jmp    801046b0 <acquire>
80104121:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  p->chan = chan;
80104128:	89 7b 28             	mov    %edi,0x28(%ebx)
  p->state = SLEEPING;
8010412b:	c7 43 14 02 00 00 00 	movl   $0x2,0x14(%ebx)
  sched();
...
80104149:	68 10 76 10 80       	push   $0x80107610
8010414e:	e8 2d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
80104153:	83 ec 0c             	sub    $0xc,%esp
80104156:	68 0a 76 10 80       	push   $0x8010760a
...
8010416f:	e8 3c 05 00 00       	call   801046b0 <acquire>
...
80104185:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
8010418a:	74 1e                	je     801041aa <wakeup+0x4a>
    if(p->state == SLEEPING && p->chan == chan)
8010418c:	83 78 14 02          	cmpl   $0x2,0x14(%eax)
80104190:	75 ee                	jne    80104180 <wakeup+0x20>
80104192:	3b 58 28             	cmp    0x28(%eax),%ebx
80104195:	75 e9                	jne    80104180 <wakeup+0x20>
      p->state = RUNNABLE;
80104197:	c7 40 14 03 00 00 00 	movl   $0x3,0x14(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010419e:	05 84 00 00 00       	add    $0x84,%eax
801041a3:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
801041a8:	75 e2                	jne    8010418c <wakeup+0x2c>
  wakeup1(chan);
  release(&ptable.lock);
801041aa:	c7 45 08 20 1d 11 80 	movl   $0x80111d20,0x8(%ebp)
}
801041b1:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801041b4:	c9                   	leave
  release(&ptable.lock);
801041b5:	e9 96 04 00 00       	jmp    80104650 <release>
...
801041ea:	74 34                	je     80104220 <kill+0x60>
    if(p->pid == pid){
801041ec:	39 58 18             	cmp    %ebx,0x18(%eax)
801041ef:	75 ef                	jne    801041e0 <kill+0x20>
      p->killed = 1;
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
801041f1:	83 78 14 02          	cmpl   $0x2,0x14(%eax)
      p->killed = 1;
801041f5:	c7 40 2c 01 00 00 00 	movl   $0x1,0x2c(%eax)
      if(p->state == SLEEPING)
801041fc:	75 07                	jne    80104205 <kill+0x45>
        p->state = RUNNABLE;
801041fe:	c7 40 14 03 00 00 00 	movl   $0x3,0x14(%eax)
      release(&ptable.lock);
80104205:	83 ec 0c             	sub    $0xc,%esp
80104208:	68 20 1d 11 80       	push   $0x80111d20
8010420d:	e8 3e 04 00 00       	call   80104650 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80104228:	e8 23 04 00 00       	call   80104650 <release>
}
...
80104249:	bb c8 1d 11 80       	mov    $0x80111dc8,%ebx
...
8010427f:	74 e7                	je     80104268 <procdump+0x28>
      state = "???";
80104281:	ba 21 76 10 80       	mov    $0x80107621,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104286:	83 f8 05             	cmp    $0x5,%eax
80104289:	77 11                	ja     8010429c <procdump+0x5c>
8010428b:	8b 14 85 00 7c 10 80 	mov    -0x7fef8400(,%eax,4),%edx
      state = "???";
80104292:	b8 21 76 10 80       	mov    $0x80107621,%eax
...
801042a1:	68 25 76 10 80       	push   $0x80107625
...
801042c8:	e8 13 02 00 00       	call   801044e0 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801042dd:	68 61 73 10 80       	push   $0x80107361
...
8010431c:	eb 32                	jmp    80104350 <get_p_info+0x50>
8010431e:	66 90                	xchg   %ax,%ax
  {
    ...
    {
      ps->inuse[indx] = 1; 
80104320:	8d 14 93             	lea    (%ebx,%edx,4),%edx
  for (p = ptable.proc ; p < &ptable.proc[NPROC] ; p++)
80104323:	05 84 00 00 00       	add    $0x84,%eax
      ps->inuse[indx] = 1; 
80104328:	c7 02 01 00 00 00    	movl   $0x1,(%edx)
      ps->pid[indx] = p->pid;
8010432e:	8b 48 94             	mov    -0x6c(%eax),%ecx
80104331:	89 8a 00 02 00 00    	mov    %ecx,0x200(%edx)
      ps->tickets[indx] = p->tickets;
80104337:	8b 48 80             	mov    -0x80(%eax),%ecx
8010433a:	89 8a 00 01 00 00    	mov    %ecx,0x100(%edx)
      ps->ticks[indx] = p->ticks ;
80104340:	8b 48 84             	mov    -0x7c(%eax),%ecx
80104343:	89 8a 00 03 00 00    	mov    %ecx,0x300(%edx)
  for (p = ptable.proc ; p < &ptable.proc[NPROC] ; p++)
80104349:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
8010434e:	74 2b                	je     8010437b <get_p_info+0x7b>
    uint indx = p - ptable.proc ;
80104350:	89 c2                	mov    %eax,%edx
    if(p->state != UNUSED)
80104352:	8b 48 14             	mov    0x14(%eax),%ecx
    uint indx = p - ptable.proc ;
80104355:	81 ea 54 1d 11 80    	sub    $0x80111d54,%edx
8010435b:	c1 fa 02             	sar    $0x2,%edx
8010435e:	69 d2 e1 83 0f 3e    	imul   $0x3e0f83e1,%edx,%edx
    if(p->state != UNUSED)
80104364:	85 c9                	test   %ecx,%ecx
80104366:	75 b8                	jne    80104320 <get_p_info+0x20>
  for (p = ptable.proc ; p < &ptable.proc[NPROC] ; p++)
80104368:	05 84 00 00 00       	add    $0x84,%eax
    }
    else
    {
      ps->inuse[indx] = 0;
8010436d:	c7 04 93 00 00 00 00 	movl   $0x0,(%ebx,%edx,4)
  for (p = ptable.proc ; p < &ptable.proc[NPROC] ; p++)
80104374:	3d 54 3e 11 80       	cmp    $0x80113e54,%eax
80104379:	75 d5                	jne    80104350 <get_p_info+0x50>
    }
  }
  release(&ptable.lock);
8010437b:	c7 45 08 20 1d 11 80 	movl   $0x80111d20,0x8(%ebp)
}
80104382:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104385:	c9                   	leave
  release(&ptable.lock);
80104386:	e9 c5 02 00 00       	jmp    80104650 <release>
...
8010439a:	68 58 76 10 80       	push   $0x80107658
...
801043c1:	c9                   	leave
801043c2:	c3                   	ret
801043c3:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801043ca:	00 
...
801043df:	e8 cc 02 00 00       	call   801046b0 <acquire>
  while (lk->locked) {
...
801043f5:	e8 a6 fc ff ff       	call   801040a0 <sleep>
  while (lk->locked) {
...
8010441c:	5d                   	pop    %ebp
  release(&lk->lk);
8010441d:	e9 2e 02 00 00       	jmp    80104650 <release>
80104422:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80104429:	00 
...
8010443f:	e8 6c 02 00 00       	call   801046b0 <acquire>
  lk->locked = 0;
...
80104454:	e8 07 fd ff ff       	call   80104160 <wakeup>
  release(&lk->lk);
...
80104464:	5d                   	pop    %ebp
  release(&lk->lk);
80104465:	e9 e6 01 00 00       	jmp    80104650 <release>
...
80104482:	e8 29 02 00 00       	call   801046b0 <acquire>
...
80104494:	e8 b7 01 00 00       	call   80104650 <release>
  return r;
}
...
801044b0:	39 58 18             	cmp    %ebx,0x18(%eax)
...
801044ed:	05 f8 ff ff 7f       	add    $0x7ffffff8,%eax
801044f2:	3d fe ff ff 7f       	cmp    $0x7ffffffe,%eax
  for(i = 0; i < 10; i++){
801044f7:	b8 00 00 00 00       	mov    $0x0,%eax
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
801044fc:	76 10                	jbe    8010450e <getcallerpcs+0x2e>
801044fe:	eb 28                	jmp    80104528 <getcallerpcs+0x48>
80104500:	8d 9a 00 00 00 80    	lea    -0x80000000(%edx),%ebx
80104506:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
8010450c:	77 1a                	ja     80104528 <getcallerpcs+0x48>
      break;
...
8010451c:	75 e2                	jne    80104500 <getcallerpcs+0x20>
  }
  for(; i < 10; i++)
    pcs[i] = 0;
}
...
80104528:	8d 04 81             	lea    (%ecx,%eax,4),%eax
8010452b:	83 c1 28             	add    $0x28,%ecx
8010452e:	89 ca                	mov    %ecx,%edx
80104530:	29 c2                	sub    %eax,%edx
80104532:	83 e2 04             	and    $0x4,%edx
80104535:	74 11                	je     80104548 <getcallerpcs+0x68>
    pcs[i] = 0;
80104537:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
8010453d:	83 c0 04             	add    $0x4,%eax
80104540:	39 c1                	cmp    %eax,%ecx
80104542:	74 da                	je     8010451e <getcallerpcs+0x3e>
80104544:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    pcs[i] = 0;
80104548:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
8010454e:	83 c0 08             	add    $0x8,%eax
    pcs[i] = 0;
80104551:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
  for(; i < 10; i++)
80104558:	39 c1                	cmp    %eax,%ecx
8010455a:	75 ec                	jne    80104548 <getcallerpcs+0x68>
8010455c:	eb c0                	jmp    8010451e <getcallerpcs+0x3e>
...
801045a3:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801045aa:	00 
...
801045f5:	68 63 76 10 80       	push   $0x80107663
801045fa:	e8 81 bd ff ff       	call   80100380 <panic>
    panic("popcli");
801045ff:	83 ec 0c             	sub    $0xc,%esp
80104602:	68 7a 76 10 80       	push   $0x8010767a
...
8010466b:	68 81 76 10 80       	push   $0x80107681
...
801046c8:	0f 85 b2 00 00 00    	jne    80104780 <acquire+0xd0>
  popcli();
801046ce:	e8 dd fe ff ff       	call   801045b0 <popcli>
  asm volatile("lock; xchgl %0, %1" :
801046d3:	b9 01 00 00 00       	mov    $0x1,%ecx
...
801046f9:	8b 4d 08             	mov    0x8(%ebp),%ecx
  for(i = 0; i < 10; i++){
801046fc:	31 d2                	xor    %edx,%edx
  lk->cpu = mycpu();
801046fe:	89 43 08             	mov    %eax,0x8(%ebx)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104701:	8d 85 00 00 00 80    	lea    -0x80000000(%ebp),%eax
80104707:	3d fe ff ff 7f       	cmp    $0x7ffffffe,%eax
8010470c:	77 32                	ja     80104740 <acquire+0x90>
  ebp = (uint*)v - 2;
8010470e:	89 e8                	mov    %ebp,%eax
80104710:	eb 14                	jmp    80104726 <acquire+0x76>
80104712:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104718:	8d 98 00 00 00 80    	lea    -0x80000000(%eax),%ebx
8010471e:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
80104724:	77 1a                	ja     80104740 <acquire+0x90>
    pcs[i] = ebp[1];     // saved %eip
80104726:	8b 58 04             	mov    0x4(%eax),%ebx
80104729:	89 5c 91 0c          	mov    %ebx,0xc(%ecx,%edx,4)
  for(i = 0; i < 10; i++){
8010472d:	83 c2 01             	add    $0x1,%edx
    ebp = (uint*)ebp[0]; // saved %ebp
80104730:	8b 00                	mov    (%eax),%eax
  for(i = 0; i < 10; i++){
80104732:	83 fa 0a             	cmp    $0xa,%edx
80104735:	75 e1                	jne    80104718 <acquire+0x68>
}
80104737:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010473a:	c9                   	leave
8010473b:	c3                   	ret
8010473c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104740:	8d 44 91 0c          	lea    0xc(%ecx,%edx,4),%eax
80104744:	83 c1 34             	add    $0x34,%ecx
80104747:	89 ca                	mov    %ecx,%edx
80104749:	29 c2                	sub    %eax,%edx
8010474b:	83 e2 04             	and    $0x4,%edx
8010474e:	74 10                	je     80104760 <acquire+0xb0>
    pcs[i] = 0;
80104750:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
80104756:	83 c0 04             	add    $0x4,%eax
80104759:	39 c1                	cmp    %eax,%ecx
8010475b:	74 da                	je     80104737 <acquire+0x87>
8010475d:	8d 76 00             	lea    0x0(%esi),%esi
    pcs[i] = 0;
80104760:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
80104766:	83 c0 08             	add    $0x8,%eax
    pcs[i] = 0;
80104769:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
  for(; i < 10; i++)
80104770:	39 c1                	cmp    %eax,%ecx
80104772:	75 ec                	jne    80104760 <acquire+0xb0>
80104774:	eb c1                	jmp    80104737 <acquire+0x87>
80104776:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010477d:	00 
8010477e:	66 90                	xchg   %ax,%ax
  r = lock->locked && lock->cpu == mycpu();
80104780:	8b 5b 08             	mov    0x8(%ebx),%ebx
80104783:	e8 68 f1 ff ff       	call   801038f0 <mycpu>
80104788:	39 c3                	cmp    %eax,%ebx
8010478a:	0f 85 3e ff ff ff    	jne    801046ce <acquire+0x1e>
  popcli();
80104790:	e8 1b fe ff ff       	call   801045b0 <popcli>
    panic("acquire");
80104795:	83 ec 0c             	sub    $0xc,%esp
80104798:	68 89 76 10 80       	push   $0x80107689
8010479d:	e8 de bb ff ff       	call   80100380 <panic>
801047a2:	66 90                	xchg   %ax,%ax
801047a4:	66 90                	xchg   %ax,%ax
...
801047ba:	89 d0                	mov    %edx,%eax
801047bc:	09 c8                	or     %ecx,%eax
801047be:	a8 03                	test   $0x3,%al
801047c0:	75 1e                	jne    801047e0 <memset+0x30>
    c &= 0xFF;
801047c2:	0f b6 45 0c          	movzbl 0xc(%ebp),%eax
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
801047c6:	c1 e9 02             	shr    $0x2,%ecx
  asm volatile("cld; rep stosl" :
801047c9:	89 d7                	mov    %edx,%edi
801047cb:	69 c0 01 01 01 01    	imul   $0x1010101,%eax,%eax
801047d1:	fc                   	cld
801047d2:	f3 ab                	rep stos %eax,%es:(%edi)
  } else
    stosb(dst, c, n);
  return dst;
}
...
801047e5:	fc                   	cld
801047e6:	f3 aa                	rep stos %al,%es:(%edi)
801047e8:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
80104818:	74 16                	je     80104830 <memcmp+0x40>
    if(*s1 != *s2)
8010481a:	0f b6 08             	movzbl (%eax),%ecx
8010481d:	0f b6 1a             	movzbl (%edx),%ebx
...
80104847:	8b 45 10             	mov    0x10(%ebp),%eax
...
80104852:	8d 0c 06             	lea    (%esi,%eax,1),%ecx
80104855:	39 ca                	cmp    %ecx,%edx
80104857:	73 1f                	jae    80104878 <memmove+0x38>
    s += n;
    d += n;
    while(n-- > 0)
80104859:	85 c0                	test   %eax,%eax
8010485b:	74 0f                	je     8010486c <memmove+0x2c>
...
80104872:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    while(n-- > 0)
80104878:	8d 0c 06             	lea    (%esi,%eax,1),%ecx
...
801048ba:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  while(n > 0 && *p && *p == *q)
801048bd:	85 d2                	test   %edx,%edx
801048bf:	75 16                	jne    801048d7 <strncmp+0x27>
801048c1:	eb 2d                	jmp    801048f0 <strncmp+0x40>
801048c3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
801048c8:	3a 19                	cmp    (%ecx),%bl
801048ca:	75 12                	jne    801048de <strncmp+0x2e>
    n--, p++, q++;
801048cc:	83 c0 01             	add    $0x1,%eax
801048cf:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
801048d2:	83 ea 01             	sub    $0x1,%edx
801048d5:	74 19                	je     801048f0 <strncmp+0x40>
801048d7:	0f b6 18             	movzbl (%eax),%ebx
801048da:	84 db                	test   %bl,%bl
801048dc:	75 ea                	jne    801048c8 <strncmp+0x18>
  if(n == 0)
    return 0;
  return (uchar)*p - (uchar)*q;
801048de:	0f b6 00             	movzbl (%eax),%eax
801048e1:	0f b6 11             	movzbl (%ecx),%edx
}
801048e4:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801048e7:	c9                   	leave
  return (uchar)*p - (uchar)*q;
801048e8:	29 d0                	sub    %edx,%eax
}
801048ea:	c3                   	ret
...
80104909:	8b 55 10             	mov    0x10(%ebp),%edx
  char *os;
...
8010491a:	0f b6 4f ff          	movzbl -0x1(%edi),%ecx
8010491e:	88 48 ff             	mov    %cl,-0x1(%eax)
80104921:	84 c9                	test   %cl,%cl
80104923:	74 13                	je     80104938 <strncpy+0x38>
80104925:	89 d3                	mov    %edx,%ebx
...
80104935:	8d 76 00             	lea    0x0(%esi),%esi
  while(n-- > 0)
80104938:	8d 0c 18             	lea    (%eax,%ebx,1),%ecx
8010493b:	83 e9 01             	sub    $0x1,%ecx
8010493e:	85 d2                	test   %edx,%edx
80104940:	74 ec                	je     8010492e <strncpy+0x2e>
80104942:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    *s++ = 0;
80104948:	83 c0 01             	add    $0x1,%eax
8010494b:	89 ca                	mov    %ecx,%edx
8010494d:	c6 40 ff 00          	movb   $0x0,-0x1(%eax)
  while(n-- > 0)
80104951:	29 c2                	sub    %eax,%edx
80104953:	85 d2                	test   %edx,%edx
80104955:	7f f1                	jg     80104948 <strncpy+0x48>
}
80104957:	5b                   	pop    %ebx
80104958:	89 f0                	mov    %esi,%eax
8010495a:	5e                   	pop    %esi
8010495b:	5f                   	pop    %edi
8010495c:	5d                   	pop    %ebp
8010495d:	c3                   	ret
...
801049d7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801049da:	e8 91 ef ff ff       	call   80103970 <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
801049df:	8b 00                	mov    (%eax),%eax
801049e1:	39 c3                	cmp    %eax,%ebx
801049e3:	73 1b                	jae    80104a00 <fetchint+0x30>
...
80104a1a:	e8 51 ef ff ff       	call   80103970 <myproc>
  ...
  if(addr >= curproc->sz)
80104a1f:	3b 18                	cmp    (%eax),%ebx
80104a21:	73 2d                	jae    80104a50 <fetchstr+0x40>
    return -1;
  *pp = (char*)addr;
...
80104a3d:	73 11                	jae    80104a50 <fetchstr+0x40>
    if(*s == 0)
...
80104a65:	e8 06 ef ff ff       	call   80103970 <myproc>
80104a6a:	8b 55 08             	mov    0x8(%ebp),%edx
80104a6d:	8b 40 20             	mov    0x20(%eax),%eax
80104a70:	8b 40 44             	mov    0x44(%eax),%eax
80104a73:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104a76:	e8 f5 ee ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104ab6:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104ab9:	e8 b2 ee ff ff       	call   80103970 <myproc>
80104abe:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104ac0:	e8 ab ee ff ff       	call   80103970 <myproc>
80104ac5:	8b 55 08             	mov    0x8(%ebp),%edx
80104ac8:	8b 40 20             	mov    0x20(%eax),%eax
80104acb:	8b 40 44             	mov    0x44(%eax),%eax
80104ace:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104ad1:	e8 9a ee ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104af2:	39 d0                	cmp    %edx,%eax
80104af4:	73 1a                	jae    80104b10 <argptr+0x60>
...
80104b24:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104b25:	e8 46 ee ff ff       	call   80103970 <myproc>
80104b2a:	8b 55 08             	mov    0x8(%ebp),%edx
80104b2d:	8b 40 20             	mov    0x20(%eax),%eax
80104b30:	8b 40 44             	mov    0x44(%eax),%eax
80104b33:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104b36:	e8 35 ee ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104b4b:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104b4e:	e8 1d ee ff ff       	call   80103970 <myproc>
  if(addr >= curproc->sz)
...
80104b73:	39 d0                	cmp    %edx,%eax
80104b75:	73 11                	jae    80104b88 <argstr+0x68>
    if(*s == 0)
...
80104be0:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80104be1:	8d 43 74             	lea    0x74(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80104be4:	50                   	push   %eax
80104be5:	ff 73 18             	push   0x18(%ebx)
80104be8:	68 91 76 10 80       	push   $0x80107691
80104bed:	e8 be ba ff ff       	call   801006b0 <cprintf>
    curproc->tf->eax = -1;
80104bf2:	8b 43 20             	mov    0x20(%ebx),%eax
...
80104c22:	89 55 d4             	mov    %edx,-0x2c(%ebp)
80104c25:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104c28:	57                   	push   %edi
80104c29:	50                   	push   %eax
80104c2a:	e8 71 d4 ff ff       	call   801020a0 <nameiparent>
80104c2f:	83 c4 10             	add    $0x10,%esp
80104c32:	85 c0                	test   %eax,%eax
80104c34:	74 5e                	je     80104c94 <create+0x84>
    return 0;
  ilock(dp);
80104c36:	83 ec 0c             	sub    $0xc,%esp
80104c39:	89 c3                	mov    %eax,%ebx
80104c3b:	50                   	push   %eax
80104c3c:	e8 5f cb ff ff       	call   801017a0 <ilock>

  if((ip = dirlookup(dp, name, 0)) != 0){
80104c41:	83 c4 0c             	add    $0xc,%esp
80104c44:	6a 00                	push   $0x0
80104c46:	57                   	push   %edi
80104c47:	53                   	push   %ebx
80104c48:	e8 a3 d0 ff ff       	call   80101cf0 <dirlookup>
80104c4d:	83 c4 10             	add    $0x10,%esp
80104c50:	89 c6                	mov    %eax,%esi
80104c52:	85 c0                	test   %eax,%eax
80104c54:	74 4a                	je     80104ca0 <create+0x90>
    iunlockput(dp);
80104c56:	83 ec 0c             	sub    $0xc,%esp
80104c59:	53                   	push   %ebx
80104c5a:	e8 d1 cd ff ff       	call   80101a30 <iunlockput>
    ilock(ip);
80104c5f:	89 34 24             	mov    %esi,(%esp)
80104c62:	e8 39 cb ff ff       	call   801017a0 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104c67:	83 c4 10             	add    $0x10,%esp
80104c6a:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80104c6f:	75 17                	jne    80104c88 <create+0x78>
80104c71:	66 83 7e 50 02       	cmpw   $0x2,0x50(%esi)
80104c76:	75 10                	jne    80104c88 <create+0x78>
...
80104c78:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104c7b:	89 f0                	mov    %esi,%eax
80104c7d:	5b                   	pop    %ebx
80104c7e:	5e                   	pop    %esi
80104c7f:	5f                   	pop    %edi
80104c80:	5d                   	pop    %ebp
...
80104c8c:	e8 9f cd ff ff       	call   80101a30 <iunlockput>
    return 0;
80104c91:	83 c4 10             	add    $0x10,%esp
}
80104c94:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return 0;
80104c97:	31 f6                	xor    %esi,%esi
}
80104c99:	5b                   	pop    %ebx
80104c9a:	89 f0                	mov    %esi,%eax
80104c9c:	5e                   	pop    %esi
80104c9d:	5f                   	pop    %edi
80104c9e:	5d                   	pop    %ebp
80104c9f:	c3                   	ret
...
80104caa:	e8 81 c9 ff ff       	call   80101630 <ialloc>
80104caf:	83 c4 10             	add    $0x10,%esp
80104cb2:	89 c6                	mov    %eax,%esi
80104cb4:	85 c0                	test   %eax,%eax
80104cb6:	0f 84 bc 00 00 00    	je     80104d78 <create+0x168>
  ilock(ip);
80104cbc:	83 ec 0c             	sub    $0xc,%esp
80104cbf:	50                   	push   %eax
80104cc0:	e8 db ca ff ff       	call   801017a0 <ilock>
  ip->major = major;
...
80104d29:	e8 c2 c9 ff ff       	call   801016f0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104d2e:	83 c4 0c             	add    $0xc,%esp
80104d31:	ff 76 04             	push   0x4(%esi)
80104d34:	68 c9 76 10 80       	push   $0x801076c9
80104d39:	56                   	push   %esi
80104d3a:	e8 81 d2 ff ff       	call   80101fc0 <dirlink>
80104d3f:	83 c4 10             	add    $0x10,%esp
80104d42:	85 c0                	test   %eax,%eax
80104d44:	78 18                	js     80104d5e <create+0x14e>
80104d46:	83 ec 04             	sub    $0x4,%esp
80104d49:	ff 73 04             	push   0x4(%ebx)
80104d4c:	68 c8 76 10 80       	push   $0x801076c8
80104d51:	56                   	push   %esi
80104d52:	e8 69 d2 ff ff       	call   80101fc0 <dirlink>
80104d57:	83 c4 10             	add    $0x10,%esp
80104d5a:	85 c0                	test   %eax,%eax
80104d5c:	79 92                	jns    80104cf0 <create+0xe0>
      panic("create dots");
80104d5e:	83 ec 0c             	sub    $0xc,%esp
80104d61:	68 bc 76 10 80       	push   $0x801076bc
80104d66:	e8 15 b6 ff ff       	call   80100380 <panic>
    panic("create: dirlink");
80104d6b:	83 ec 0c             	sub    $0xc,%esp
80104d6e:	68 cb 76 10 80       	push   $0x801076cb
80104d73:	e8 08 b6 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104d78:	83 ec 0c             	sub    $0xc,%esp
80104d7b:	68 ad 76 10 80       	push   $0x801076ad
80104d80:	e8 fb b5 ff ff       	call   80100380 <panic>
80104d85:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80104d8c:	00 
...
80104d9e:	e8 bd fc ff ff       	call   80104a60 <argint>
...
80104db8:	8b 74 90 30          	mov    0x30(%eax,%edx,4),%esi
...
80104dd0:	8b 54 98 30          	mov    0x30(%eax,%ebx,4),%edx
...
80104df0:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80104df3:	89 74 98 30          	mov    %esi,0x30(%eax,%ebx,4)
  filedup(f);
80104df7:	56                   	push   %esi
80104df8:	e8 c3 c0 ff ff       	call   80100ec0 <filedup>
  return fd;
...
80104e1e:	e8 3d fc ff ff       	call   80104a60 <argint>
...
80104e38:	8b 74 90 30          	mov    0x30(%eax,%edx,4),%esi
...
80104e49:	e8 12 fc ff ff       	call   80104a60 <argint>
...
80104e5e:	e8 4d fc ff ff       	call   80104ab0 <argptr>
...
80104e74:	e8 c7 c1 ff ff       	call   80101040 <fileread>
...
80104e9e:	e8 bd fb ff ff       	call   80104a60 <argint>
...
80104eb8:	8b 74 90 30          	mov    0x30(%eax,%edx,4),%esi
...
80104ec9:	e8 92 fb ff ff       	call   80104a60 <argint>
...
80104ede:	e8 cd fb ff ff       	call   80104ab0 <argptr>
...
80104ef4:	e8 d7 c1 ff ff       	call   801010d0 <filewrite>
...
80104f1e:	e8 3d fb ff ff       	call   80104a60 <argint>
...
80104f38:	8d 5a 0c             	lea    0xc(%edx),%ebx
80104f3b:	8b 34 98             	mov    (%eax,%ebx,4),%esi
80104f3e:	85 f6                	test   %esi,%esi
80104f40:	74 26                	je     80104f68 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80104f42:	e8 29 ea ff ff       	call   80103970 <myproc>
  fileclose(f);
80104f47:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
80104f4a:	c7 04 98 00 00 00 00 	movl   $0x0,(%eax,%ebx,4)
  fileclose(f);
80104f51:	56                   	push   %esi
80104f52:	e8 b9 bf ff ff       	call   80100f10 <fileclose>
  return 0;
...
80104f6d:	eb ed                	jmp    80104f5c <sys_close+0x4c>
80104f6f:	90                   	nop
...
80104f7e:	e8 dd fa ff ff       	call   80104a60 <argint>
...
80104fa8:	e8 03 fb ff ff       	call   80104ab0 <argptr>
...
80104fbb:	e8 30 c0 ff ff       	call   80100ff0 <filestat>
...
80104fef:	e8 2c fb ff ff       	call   80104b20 <argstr>
...
80105058:	e8 93 c6 ff ff       	call   801016f0 <iupdate>
  iunlock(ip);
8010505d:	89 1c 24             	mov    %ebx,(%esp)
80105060:	e8 1b c8 ff ff       	call   80101880 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80105065:	58                   	pop    %eax
80105066:	5a                   	pop    %edx
80105067:	57                   	push   %edi
80105068:	ff 75 d0             	push   -0x30(%ebp)
8010506b:	e8 30 d0 ff ff       	call   801020a0 <nameiparent>
...
8010507d:	e8 1e c7 ff ff       	call   801017a0 <ilock>
...
80105093:	e8 28 cf ff ff       	call   80101fc0 <dirlink>
...
801050a3:	e8 88 c9 ff ff       	call   80101a30 <iunlockput>
  iput(ip);
801050a8:	89 1c 24             	mov    %ebx,(%esp)
801050ab:	e8 20 c8 ff ff       	call   801018d0 <iput>
  end_op();
801050b0:	e8 fb dc ff ff       	call   80102db0 <end_op>
  return 0;
...
801050cc:	e8 5f c9 ff ff       	call   80101a30 <iunlockput>
    goto bad;
...
801050e5:	e8 06 c6 ff ff       	call   801016f0 <iupdate>
  iunlockput(ip);
801050ea:	89 1c 24             	mov    %ebx,(%esp)
801050ed:	e8 3e c9 ff ff       	call   80101a30 <iunlockput>
  end_op();
801050f2:	e8 b9 dc ff ff       	call   80102db0 <end_op>
  return -1;
...
80105105:	e8 26 c9 ff ff       	call   80101a30 <iunlockput>
    end_op();
8010510a:	e8 a1 dc ff ff       	call   80102db0 <end_op>
    return -1;
8010510f:	83 c4 10             	add    $0x10,%esp
80105112:	eb e6                	jmp    801050fa <sys_link+0x11a>
    end_op();
80105114:	e8 97 dc ff ff       	call   80102db0 <end_op>
    return -1;
80105119:	eb df                	jmp    801050fa <sys_link+0x11a>
...
8010512f:	e8 ec f9 ff ff       	call   80104b20 <argstr>
80105134:	83 c4 10             	add    $0x10,%esp
80105137:	85 c0                	test   %eax,%eax
80105139:	0f 88 54 01 00 00    	js     80105293 <sys_unlink+0x173>
  begin_op();
8010513f:	e8 fc db ff ff       	call   80102d40 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105144:	8d 5d ca             	lea    -0x36(%ebp),%ebx
80105147:	83 ec 08             	sub    $0x8,%esp
8010514a:	53                   	push   %ebx
8010514b:	ff 75 c0             	push   -0x40(%ebp)
8010514e:	e8 4d cf ff ff       	call   801020a0 <nameiparent>
80105153:	83 c4 10             	add    $0x10,%esp
80105156:	89 45 b4             	mov    %eax,-0x4c(%ebp)
80105159:	85 c0                	test   %eax,%eax
8010515b:	0f 84 58 01 00 00    	je     801052b9 <sys_unlink+0x199>
  ilock(dp);
80105161:	8b 7d b4             	mov    -0x4c(%ebp),%edi
80105164:	83 ec 0c             	sub    $0xc,%esp
80105167:	57                   	push   %edi
80105168:	e8 33 c6 ff ff       	call   801017a0 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
8010516d:	58                   	pop    %eax
8010516e:	5a                   	pop    %edx
8010516f:	68 c9 76 10 80       	push   $0x801076c9
80105174:	53                   	push   %ebx
80105175:	e8 56 cb ff ff       	call   80101cd0 <namecmp>
...
80105188:	68 c8 76 10 80       	push   $0x801076c8
8010518d:	53                   	push   %ebx
8010518e:	e8 3d cb ff ff       	call   80101cd0 <namecmp>
...
801051a7:	e8 44 cb ff ff       	call   80101cf0 <dirlookup>
...
801051bd:	e8 de c5 ff ff       	call   801017a0 <ilock>
  if(ip->nlink < 1)
801051c2:	83 c4 10             	add    $0x10,%esp
801051c5:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
801051ca:	0f 8e 0a 01 00 00    	jle    801052da <sys_unlink+0x1ba>
...
80105212:	e8 19 c8 ff ff       	call   80101a30 <iunlockput>
  ip->nlink--;
80105217:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
8010521c:	89 1c 24             	mov    %ebx,(%esp)
8010521f:	e8 cc c4 ff ff       	call   801016f0 <iupdate>
  iunlockput(ip);
80105224:	89 1c 24             	mov    %ebx,(%esp)
80105227:	e8 04 c8 ff ff       	call   80101a30 <iunlockput>
  end_op();
8010522c:	e8 7f db ff ff       	call   80102db0 <end_op>
  return 0;
...
8010525d:	e8 4e c8 ff ff       	call   80101ab0 <readi>
80105262:	83 c4 10             	add    $0x10,%esp
80105265:	83 f8 10             	cmp    $0x10,%eax
80105268:	75 56                	jne    801052c0 <sys_unlink+0x1a0>
    if(de.inum != 0)
...
80105275:	e8 b6 c7 ff ff       	call   80101a30 <iunlockput>
    goto bad;
...
80105286:	e8 a5 c7 ff ff       	call   80101a30 <iunlockput>
  end_op();
8010528b:	e8 20 db ff ff       	call   80102db0 <end_op>
  return -1;
...
801052ac:	e8 3f c4 ff ff       	call   801016f0 <iupdate>
801052b1:	83 c4 10             	add    $0x10,%esp
801052b4:	e9 53 ff ff ff       	jmp    8010520c <sys_unlink+0xec>
    end_op();
801052b9:	e8 f2 da ff ff       	call   80102db0 <end_op>
    return -1;
801052be:	eb d3                	jmp    80105293 <sys_unlink+0x173>
      panic("isdirempty: readi");
801052c0:	83 ec 0c             	sub    $0xc,%esp
801052c3:	68 ed 76 10 80       	push   $0x801076ed
801052c8:	e8 b3 b0 ff ff       	call   80100380 <panic>
    panic("unlink: writei");
801052cd:	83 ec 0c             	sub    $0xc,%esp
801052d0:	68 ff 76 10 80       	push   $0x801076ff
801052d5:	e8 a6 b0 ff ff       	call   80100380 <panic>
    panic("unlink: nlink < 1");
801052da:	83 ec 0c             	sub    $0xc,%esp
801052dd:	68 db 76 10 80       	push   $0x801076db
801052e2:	e8 99 b0 ff ff       	call   80100380 <panic>
...
801052ff:	e8 1c f8 ff ff       	call   80104b20 <argstr>
...
80105318:	e8 43 f7 ff ff       	call   80104a60 <argint>
...
80105322:	78 79                	js     8010539d <sys_open+0xad>
  ...
  begin_op();
80105324:	e8 17 da ff ff       	call   80102d40 <begin_op>
...
80105335:	e8 46 cd ff ff       	call   80102080 <namei>
...
8010534b:	e8 50 c4 ff ff       	call   801017a0 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105350:	83 c4 10             	add    $0x10,%esp
80105353:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
80105358:	0f 84 ba 00 00 00    	je     80105418 <sys_open+0x128>
      end_op();
      return -1;
    }
  }
...
8010535e:	e8 ed ba ff ff       	call   80100e50 <filealloc>
...
8010536e:	31 db                	xor    %ebx,%ebx
    if(curproc->ofile[fd] == 0){
80105370:	8b 54 98 30          	mov    0x30(%eax,%ebx,4),%edx
80105374:	85 d2                	test   %edx,%edx
80105376:	74 58                	je     801053d0 <sys_open+0xe0>
  for(fd = 0; fd < NOFILE; fd++){
...
80105384:	e8 87 bb ff ff       	call   80100f10 <fileclose>
80105389:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
8010538c:	83 ec 0c             	sub    $0xc,%esp
8010538f:	56                   	push   %esi
80105390:	e8 9b c6 ff ff       	call   80101a30 <iunlockput>
    end_op();
80105395:	e8 16 da ff ff       	call   80102db0 <end_op>
    return -1;
8010539a:	83 c4 10             	add    $0x10,%esp
    return -1;
8010539d:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801053a2:	eb 65                	jmp    80105409 <sys_open+0x119>
801053a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ip = create(path, T_FILE, 0, 0);
801053a8:	83 ec 0c             	sub    $0xc,%esp
801053ab:	31 c9                	xor    %ecx,%ecx
801053ad:	ba 02 00 00 00       	mov    $0x2,%edx
801053b2:	6a 00                	push   $0x0
801053b4:	8b 45 e0             	mov    -0x20(%ebp),%eax
801053b7:	e8 54 f8 ff ff       	call   80104c10 <create>
    if(ip == 0){
...
801053c3:	75 99                	jne    8010535e <sys_open+0x6e>
      end_op();
801053c5:	e8 e6 d9 ff ff       	call   80102db0 <end_op>
      return -1;
801053ca:	eb d1                	jmp    8010539d <sys_open+0xad>
801053cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  }
  iunlock(ip);
801053d0:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
801053d3:	89 7c 98 30          	mov    %edi,0x30(%eax,%ebx,4)
  iunlock(ip);
801053d7:	56                   	push   %esi
801053d8:	e8 a3 c4 ff ff       	call   80101880 <iunlock>
  end_op();
801053dd:	e8 ce d9 ff ff       	call   80102db0 <end_op>
...
8010541d:	0f 84 3b ff ff ff    	je     8010535e <sys_open+0x6e>
80105423:	e9 64 ff ff ff       	jmp    8010538c <sys_open+0x9c>
80105428:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010542f:	00 
...
80105433:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105436:	e8 05 d9 ff ff       	call   80102d40 <begin_op>
...
8010545f:	e8 ac f7 ff ff       	call   80104c10 <create>
...
8010546f:	e8 bc c5 ff ff       	call   80101a30 <iunlockput>
  end_op();
80105474:	e8 37 d9 ff ff       	call   80102db0 <end_op>
  return 0;
...
8010547f:	c3                   	ret
    end_op();
80105480:	e8 2b d9 ff ff       	call   80102db0 <end_op>
    return -1;
...
80105493:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105496:	e8 a5 d8 ff ff       	call   80102d40 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
801054b9:	e8 a2 f5 ff ff       	call   80104a60 <argint>
  if((argstr(0, &path)) < 0 ||
...
801054ce:	e8 8d f5 ff ff       	call   80104a60 <argint>
     argint(1, &major) < 0 ||
...
801054ee:	e8 1d f7 ff ff       	call   80104c10 <create>
     argint(2, &minor) < 0 ||
...
801054fe:	e8 2d c5 ff ff       	call   80101a30 <iunlockput>
  end_op();
80105503:	e8 a8 d8 ff ff       	call   80102db0 <end_op>
  return 0;
...
8010552d:	89 c6                	mov    %eax,%esi
  ...
  begin_op();
8010552f:	e8 0c d8 ff ff       	call   80102d40 <begin_op>
...
8010554f:	e8 2c cb ff ff       	call   80102080 <namei>
...
80105561:	e8 3a c2 ff ff       	call   801017a0 <ilock>
  if(ip->type != T_DIR){
...
80105574:	e8 07 c3 ff ff       	call   80101880 <iunlock>
  iput(curproc->cwd);
80105579:	58                   	pop    %eax
8010557a:	ff 76 70             	push   0x70(%esi)
8010557d:	e8 4e c3 ff ff       	call   801018d0 <iput>
  end_op();
80105582:	e8 29 d8 ff ff       	call   80102db0 <end_op>
  curproc->cwd = ip;
80105587:	89 5e 70             	mov    %ebx,0x70(%esi)
  return 0;
...
801055a4:	e8 87 c4 ff ff       	call   80101a30 <iunlockput>
    end_op();
...
801055bf:	00 
    end_op();
801055c0:	e8 eb d7 ff ff       	call   80102db0 <end_op>
    return -1;
801055c5:	eb ea                	jmp    801055b1 <sys_chdir+0x91>
...
80105601:	e8 5a f4 ff ff       	call   80104a60 <argint>
...
80105620:	e8 8b f1 ff ff       	call   801047b0 <memset>
...
8010564a:	e8 81 f3 ff ff       	call   801049d0 <fetchint>
...
80105668:	e8 a3 f3 ff ff       	call   80104a10 <fetchstr>
...
801056d1:	e8 da f3 ff ff       	call   80104ab0 <argptr>
801056d6:	83 c4 10             	add    $0x10,%esp
801056d9:	85 c0                	test   %eax,%eax
801056db:	0f 88 82 00 00 00    	js     80105763 <sys_pipe+0xa3>
    return -1;
  if(pipealloc(&rf, &wf) < 0)
801056e1:	83 ec 08             	sub    $0x8,%esp
801056e4:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801056e7:	50                   	push   %eax
801056e8:	8d 45 e0             	lea    -0x20(%ebp),%eax
801056eb:	50                   	push   %eax
801056ec:	e8 1f dd ff ff       	call   80103410 <pipealloc>
801056f1:	83 c4 10             	add    $0x10,%esp
801056f4:	85 c0                	test   %eax,%eax
801056f6:	78 6b                	js     80105763 <sys_pipe+0xa3>
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
801056f8:	8b 7d e0             	mov    -0x20(%ebp),%edi
  for(fd = 0; fd < NOFILE; fd++){
801056fb:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801056fd:	e8 6e e2 ff ff       	call   80103970 <myproc>
    if(curproc->ofile[fd] == 0){
80105702:	8b 74 98 30          	mov    0x30(%eax,%ebx,4),%esi
80105706:	85 f6                	test   %esi,%esi
80105708:	74 16                	je     80105720 <sys_pipe+0x60>
8010570a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(fd = 0; fd < NOFILE; fd++){
80105710:	83 c3 01             	add    $0x1,%ebx
80105713:	83 fb 10             	cmp    $0x10,%ebx
80105716:	74 34                	je     8010574c <sys_pipe+0x8c>
    if(curproc->ofile[fd] == 0){
80105718:	8b 74 98 30          	mov    0x30(%eax,%ebx,4),%esi
8010571c:	85 f6                	test   %esi,%esi
8010571e:	75 f0                	jne    80105710 <sys_pipe+0x50>
      curproc->ofile[fd] = f;
80105720:	8d 73 0c             	lea    0xc(%ebx),%esi
80105723:	89 3c b0             	mov    %edi,(%eax,%esi,4)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80105726:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
80105729:	e8 42 e2 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
8010572e:	31 d2                	xor    %edx,%edx
    if(curproc->ofile[fd] == 0){
80105730:	8b 4c 90 30          	mov    0x30(%eax,%edx,4),%ecx
80105734:	85 c9                	test   %ecx,%ecx
80105736:	74 38                	je     80105770 <sys_pipe+0xb0>
  for(fd = 0; fd < NOFILE; fd++){
80105738:	83 c2 01             	add    $0x1,%edx
8010573b:	83 fa 10             	cmp    $0x10,%edx
8010573e:	75 f0                	jne    80105730 <sys_pipe+0x70>
    if(fd0 >= 0)
      myproc()->ofile[fd0] = 0;
80105740:	e8 2b e2 ff ff       	call   80103970 <myproc>
80105745:	c7 04 b0 00 00 00 00 	movl   $0x0,(%eax,%esi,4)
    fileclose(rf);
8010574c:	83 ec 0c             	sub    $0xc,%esp
8010574f:	ff 75 e0             	push   -0x20(%ebp)
80105752:	e8 b9 b7 ff ff       	call   80100f10 <fileclose>
    fileclose(wf);
80105757:	58                   	pop    %eax
80105758:	ff 75 e4             	push   -0x1c(%ebp)
8010575b:	e8 b0 b7 ff ff       	call   80100f10 <fileclose>
    return -1;
80105760:	83 c4 10             	add    $0x10,%esp
    return -1;
80105763:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105768:	eb 17                	jmp    80105781 <sys_pipe+0xc1>
8010576a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      curproc->ofile[fd] = f;
80105770:	89 7c 90 30          	mov    %edi,0x30(%eax,%edx,4)
  }
  fd[0] = fd0;
...
{
  return fork();
80105790:	e9 7b e3 ff ff       	jmp    80103b10 <fork>
...
801057a3:	83 ec 08             	sub    $0x8,%esp
  exit();
801057a6:	e8 45 e6 ff ff       	call   80103df0 <exit>
...
{
  return wait();
801057b0:	e9 6b e7 ff ff       	jmp    80103f20 <wait>
...
801057de:	e8 dd e9 ff ff       	call   801041c0 <kill>
...
80105803:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105806:	e8 65 e1 ff ff       	call   80103970 <myproc>
...
80105827:	78 27                	js     80105850 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105829:	e8 42 e1 ff ff       	call   80103970 <myproc>
  if(growproc(n) < 0)
8010582e:	83 ec 0c             	sub    $0xc,%esp
  addr = myproc()->sz;
80105831:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80105833:	ff 75 f4             	push   -0xc(%ebp)
80105836:	e8 55 e2 ff ff       	call   80103a90 <growproc>
...
80105877:	78 64                	js     801058dd <sys_sleep+0x7d>
    return -1;
  acquire(&tickslock);
80105879:	83 ec 0c             	sub    $0xc,%esp
8010587c:	68 80 3e 11 80       	push   $0x80113e80
80105881:	e8 2a ee ff ff       	call   801046b0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105886:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
80105889:	8b 1d 60 3e 11 80    	mov    0x80113e60,%ebx
  while(ticks - ticks0 < n){
8010588f:	83 c4 10             	add    $0x10,%esp
80105892:	85 d2                	test   %edx,%edx
80105894:	75 2b                	jne    801058c1 <sys_sleep+0x61>
80105896:	eb 58                	jmp    801058f0 <sys_sleep+0x90>
...
801058a8:	68 60 3e 11 80       	push   $0x80113e60
801058ad:	e8 ee e7 ff ff       	call   801040a0 <sleep>
  while(ticks - ticks0 < n){
801058b2:	a1 60 3e 11 80       	mov    0x80113e60,%eax
...
801058bf:	73 2f                	jae    801058f0 <sys_sleep+0x90>
    if(myproc()->killed){
801058c1:	e8 aa e0 ff ff       	call   80103970 <myproc>
801058c6:	8b 40 2c             	mov    0x2c(%eax),%eax
...
801058d5:	e8 76 ed ff ff       	call   80104650 <release>
      return -1;
...
801058f8:	e8 53 ed ff ff       	call   80104650 <release>
}
...
80105914:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105917:	68 80 3e 11 80       	push   $0x80113e80
8010591c:	e8 8f ed ff ff       	call   801046b0 <acquire>
  xticks = ticks;
80105921:	8b 1d 60 3e 11 80    	mov    0x80113e60,%ebx
  release(&tickslock);
80105927:	c7 04 24 80 3e 11 80 	movl   $0x80113e80,(%esp)
8010592e:	e8 1d ed ff ff       	call   80104650 <release>
  return xticks;
}
...
8010594d:	e8 0e f1 ff ff       	call   80104a60 <argint>
80105952:	83 c4 10             	add    $0x10,%esp
80105955:	85 c0                	test   %eax,%eax
80105957:	78 17                	js     80105970 <sys_settickets+0x30>
    return -1;
  myproc()->tickets = n ;
80105959:	8b 5d f4             	mov    -0xc(%ebp),%ebx
8010595c:	e8 0f e0 ff ff       	call   80103970 <myproc>
80105961:	89 58 04             	mov    %ebx,0x4(%eax)
  return 0;
80105964:	31 c0                	xor    %eax,%eax
}
80105966:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105969:	c9                   	leave
8010596a:	c3                   	ret
8010596b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    return -1;
80105970:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105975:	eb ef                	jmp    80105966 <sys_settickets+0x26>
80105977:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010597e:	00 
8010597f:	90                   	nop

80105980 <sys_getpinfo>:
...
80105989:	68 00 04 00 00       	push   $0x400
8010598e:	50                   	push   %eax
8010598f:	6a 00                	push   $0x0
  struct pstat * ps = 0 ;
80105991:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  if(argptr(0,(void *)&ps, sizeof(*ps)) < 0)
80105998:	e8 13 f1 ff ff       	call   80104ab0 <argptr>
8010599d:	83 c4 10             	add    $0x10,%esp
801059a0:	85 c0                	test   %eax,%eax
801059a2:	78 1c                	js     801059c0 <sys_getpinfo+0x40>
    return -1;
  get_p_info(ps);
801059a4:	83 ec 0c             	sub    $0xc,%esp
801059a7:	ff 75 f4             	push   -0xc(%ebp)
801059aa:	e8 51 e9 ff ff       	call   80104300 <get_p_info>
  return 0;
801059af:	83 c4 10             	add    $0x10,%esp
801059b2:	31 c0                	xor    %eax,%eax
}
801059b4:	c9                   	leave
801059b5:	c3                   	ret
...
80105a3e:	00 00 ef 
  initlock(&tickslock, "time");
80105a41:	68 0e 77 10 80       	push   $0x8010770e
...
80105a54:	66 a3 c6 40 11 80    	mov    %ax,0x801140c6
  initlock(&tickslock, "time");
80105a5a:	e8 61 ea ff ff       	call   801044c0 <initlock>
}
...
80105ac4:	ff 24 85 80 7c 10 80 	jmp    *-0x7fef8380(,%eax,4)
...
80105ae3:	e8 88 de ff ff       	call   80103970 <myproc>
80105ae8:	8b 50 2c             	mov    0x2c(%eax),%edx
...
80105afd:	e8 6e de ff ff       	call   80103970 <myproc>
80105b02:	85 c0                	test   %eax,%eax
80105b04:	74 0f                	je     80105b15 <trap+0x75>
80105b06:	e8 65 de ff ff       	call   80103970 <myproc>
80105b0b:	83 78 14 04          	cmpl   $0x4,0x14(%eax)
...
80105b1e:	e8 4d de ff ff       	call   80103970 <myproc>
80105b23:	8b 40 2c             	mov    0x2c(%eax),%eax
...
80105b8e:	83 c6 74             	add    $0x74,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105b91:	56                   	push   %esi
80105b92:	ff 70 18             	push   0x18(%eax)
80105b95:	68 5c 79 10 80       	push   $0x8010795c
80105b9a:	e8 11 ab ff ff       	call   801006b0 <cprintf>
    myproc()->killed = 1;
80105b9f:	83 c4 20             	add    $0x20,%esp
80105ba2:	e8 c9 dd ff ff       	call   80103970 <myproc>
80105ba7:	c7 40 2c 01 00 00 00 	movl   $0x1,0x2c(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
...
80105be7:	68 04 79 10 80       	push   $0x80107904
80105bec:	e8 bf aa ff ff       	call   801006b0 <cprintf>
    lapiceoi();
80105bf1:	e8 fa cc ff ff       	call   801028f0 <lapiceoi>
    break;
...
80105c15:	8b 70 2c             	mov    0x2c(%eax),%esi
...
80105c25:	89 58 20             	mov    %ebx,0x20(%eax)
    syscall();
80105c28:	e8 73 ef ff ff       	call   80104ba0 <syscall>
    if(myproc()->killed)
80105c2d:	e8 3e dd ff ff       	call   80103970 <myproc>
80105c32:	8b 48 2c             	mov    0x2c(%eax),%ecx
...
80105c50:	e8 4b 02 00 00       	call   80105ea0 <uartintr>
    lapiceoi();
80105c55:	e8 96 cc ff ff       	call   801028f0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
...
80105c6c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105c70:	e8 4b cb ff ff       	call   801027c0 <kbdintr>
    lapiceoi();
80105c75:	e8 76 cc ff ff       	call   801028f0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
...
80105ca0:	68 80 3e 11 80       	push   $0x80113e80
80105ca5:	e8 06 ea ff ff       	call   801046b0 <acquire>
      ticks++;
80105caa:	83 05 60 3e 11 80 01 	addl   $0x1,0x80113e60
      wakeup(&ticks);
80105cb1:	c7 04 24 60 3e 11 80 	movl   $0x80113e60,(%esp)
80105cb8:	e8 a3 e4 ff ff       	call   80104160 <wakeup>
      release(&tickslock);
80105cbd:	c7 04 24 80 3e 11 80 	movl   $0x80113e80,(%esp)
80105cc4:	e8 87 e9 ff ff       	call   80104650 <release>
...
80105d03:	68 28 79 10 80       	push   $0x80107928
80105d08:	e8 a3 a9 ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105d0d:	83 c4 14             	add    $0x14,%esp
80105d10:	68 13 77 10 80       	push   $0x80107713
...
{
  if(!uart)
80105d20:	a1 c0 46 11 80       	mov    0x801146c0,%eax
...
80105da7:	0f 84 7c 00 00 00    	je     80105e29 <uartinit+0xd9>
  uart = 1;
80105dad:	c7 05 c0 46 11 80 01 	movl   $0x1,0x801146c0
80105db4:	00 00 00 
...
80105dc0:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105dc3:	bf 18 77 10 80       	mov    $0x80107718,%edi
...
80105ddd:	8d 76 00             	lea    0x0(%esi),%esi
  if(!uart)
80105de0:	a1 c0 46 11 80       	mov    0x801146c0,%eax
...
80105dfd:	e8 0e cb ff ff       	call   80102910 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
...
801069e1:	68 ec 74 10 80       	push   $0x801074ec
...
80106a87:	e8 24 dd ff ff       	call   801047b0 <memset>
...
80106acd:	68 20 77 10 80       	push   $0x80107720
...
80106ae3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106ae6:	e8 65 ce ff ff       	call   80103950 <cpuid>
  pd[0] = size-1;
...
80106b70:	a1 c4 46 11 80       	mov    0x801146c4,%eax
...
80106baf:	e8 3c cd ff ff       	call   801038f0 <mycpu>
80106bb4:	89 c3                	mov    %eax,%ebx
80106bb6:	e8 35 cd ff ff       	call   801038f0 <mycpu>
80106bbb:	89 c7                	mov    %eax,%edi
80106bbd:	e8 2e cd ff ff       	call   801038f0 <mycpu>
80106bc2:	83 c7 08             	add    $0x8,%edi
80106bc5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106bc8:	e8 23 cd ff ff       	call   801038f0 <mycpu>
...
80106cf0:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106cf1:	e9 4a db ff ff       	jmp    80104840 <memmove>
    panic("inituvm: more than a page");
80106cf6:	83 ec 0c             	sub    $0xc,%esp
80106cf9:	68 65 77 10 80       	push   $0x80107765
...
80106d48:	68 7f 77 10 80       	push   $0x8010777f
...
80106dd0:	68 a0 79 10 80       	push   $0x801079a0
...
80106e2b:	e8 80 d9 ff ff       	call   801047b0 <memset>
...
80106e6d:	68 9d 77 10 80       	push   $0x8010779d
...
80106eb3:	68 b5 77 10 80       	push   $0x801077b5
...
80106f9c:	68 d1 77 10 80       	push   $0x801077d1
...
8010703b:	a3 c4 46 11 80       	mov    %eax,0x801146c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010706c:	68 e2 77 10 80       	push   $0x801077e2
...
801070e2:	68 ec 77 10 80       	push   $0x801077ec
...
801071b7:	68 06 78 10 80       	push   $0x80107806
...
80107270:	e8 cb d5 ff ff       	call   80104840 <memmove>
    len -= n;
    buf += n;
...
int getRandomNumber(int min, int max) {
    ...
    seed = (A * seed + C) % M;
801072f0:	69 05 60 a4 10 80 6d 	imul   $0x41c64e6d,0x8010a460,%eax
801072f7:	4e c6 41 
int getRandomNumber(int min, int max) {
...
801072fd:	53                   	push   %ebx
    seed = (A * seed + C) % M;
801072fe:	05 39 30 00 00       	add    $0x3039,%eax
int getRandomNumber(int min, int max) {
80107303:	8b 4d 08             	mov    0x8(%ebp),%ecx
    
    // Calculate the range of the random number
    int range = max - min + 1;
80107306:	8b 5d 0c             	mov    0xc(%ebp),%ebx
    
    // Generate a random number within the specified range
    int randomNumber = min + (seed % range);
80107309:	99                   	cltd
    seed = (A * seed + C) % M;
8010730a:	a3 60 a4 10 80       	mov    %eax,0x8010a460
    int range = max - min + 1;
8010730f:	29 cb                	sub    %ecx,%ebx
80107311:	83 c3 01             	add    $0x1,%ebx
    int randomNumber = min + (seed % range);
80107314:	f7 fb                	idiv   %ebx
    
    return randomNumber;
}
80107316:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80107319:	c9                   	leave
    int randomNumber = min + (seed % range);
8010731a:	8d 04 0a             	lea    (%edx,%ecx,1),%eax
}
8010731d:	c3                   	ret
