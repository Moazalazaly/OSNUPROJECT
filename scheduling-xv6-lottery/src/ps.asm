...
main (void)
{
  ...
  struct pstat p ;
  if (getpinfo(&p) < 0) {
   f:	8d 9d e8 fb ff ff    	lea    -0x418(%ebp),%ebx
  15:	8d b5 e8 fc ff ff    	lea    -0x318(%ebp),%esi
{
  1b:	51                   	push   %ecx
  1c:	81 ec 18 04 00 00    	sub    $0x418,%esp
  if (getpinfo(&p) < 0) {
  22:	53                   	push   %ebx
  23:	e8 73 03 00 00       	call   39b <getpinfo>
  28:	83 c4 10             	add    $0x10,%esp
  2b:	85 c0                	test   %eax,%eax
  2d:	79 10                	jns    3f <main+0x3f>
  2f:	eb 6f                	jmp    a0 <main+0xa0>
  ...
  3d:	74 61                	je     a0 <main+0xa0>
    if (p.inuse[i] == 1) 
  3f:	83 3b 01             	cmpl   $0x1,(%ebx)
  42:	75 f4                	jne    38 <main+0x38>
    {
       printf(1,"pid : %d \n",p.pid[i]);
  44:	83 ec 04             	sub    $0x4,%esp
  47:	ff b3 00 02 00 00    	push   0x200(%ebx)
  for (int i = 0 ; i < NPROC ; i++) {
  4d:	83 c3 04             	add    $0x4,%ebx
       printf(1,"pid : %d \n",p.pid[i]);
  50:	68 58 07 00 00       	push   $0x758
  55:	6a 01                	push   $0x1
  57:	e8 f4 03 00 00       	call   450 <printf>
       printf(1,"tickets : %d \n",p.tickets[i]);
  5c:	83 c4 0c             	add    $0xc,%esp
  5f:	ff b3 fc 00 00 00    	push   0xfc(%ebx)
  65:	68 63 07 00 00       	push   $0x763
  6a:	6a 01                	push   $0x1
  6c:	e8 df 03 00 00       	call   450 <printf>
       printf(1,"ticks : %d \n",p.ticks[i]);
  71:	83 c4 0c             	add    $0xc,%esp
  74:	ff b3 fc 02 00 00    	push   0x2fc(%ebx)
  7a:	68 72 07 00 00       	push   $0x772
  7f:	6a 01                	push   $0x1
  81:	e8 ca 03 00 00       	call   450 <printf>
       printf(1, "----------------------\n");
  86:	58                   	pop    %eax
  87:	5a                   	pop    %edx
  88:	68 7f 07 00 00       	push   $0x77f
  8d:	6a 01                	push   $0x1
  8f:	e8 bc 03 00 00       	call   450 <printf>
  94:	83 c4 10             	add    $0x10,%esp
  for (int i = 0 ; i < NPROC ; i++) {
  97:	39 f3                	cmp    %esi,%ebx
  99:	75 a4                	jne    3f <main+0x3f>
  9b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    exit();
  a0:	e8 4e 02 00 00       	call   2f3 <exit>
  a5:	66 90                	xchg   %ax,%ax
  a7:	66 90                	xchg   %ax,%ax
  a9:	66 90                	xchg   %ax,%ax
  ab:	66 90                	xchg   %ax,%ax
 ...
 3b8:	89 d1                	mov    %edx,%ecx
{
 ...
 3eb:	0f b6 92 f8 07 00 00 	movzbl 0x7f8(%edx),%edx
 ...
 459:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4c4:	ff 24 85 a0 07 00 00 	jmp    *0x7a0(,%eax,4)
 ...
 5d0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5d5:	bb 97 07 00 00       	mov    $0x797,%ebx
 ...
 5e1:	a1 9c 0a 00 00       	mov    0xa9c,%eax
{
 ...
 61f:	5b                   	pop    %ebx
  freep = p;
 620:	a3 9c 0a 00 00       	mov    %eax,0xa9c
}
 625:	5e                   	pop    %esi
 626:	5f                   	pop    %edi
 627:	5d                   	pop    %ebp
 ...
 636:	72 ce                	jb     606 <free+0x26>
{
 ...
 657:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 65a:	a3 9c 0a 00 00       	mov    %eax,0xa9c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 15 9c 0a 00 00    	mov    0xa9c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bb:	3b 05 9c 0a 00 00    	cmp    0xa9c,%eax
 ...
 6de:	e8 fd fe ff ff       	call   5e0 <free>
  return freep;
 6e3:	8b 15 9c 0a 00 00    	mov    0xa9c,%edx
 ...
 727:	0a 00 00 
    base.s.size = 0;
 72a:	b8 a0 0a 00 00       	mov    $0xaa0,%eax
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 a0 0a 00 00 a0 	movl   $0xaa0,0xaa0
 736:	0a 00 00 
    base.s.size = 0;
 739:	c7 05 a4 0a 00 00 00 	movl   $0x0,0xaa4
 740:	00 00 00 
    if(p->s.size >= nunits){
