...
int x = getpinfo(&p);
  11:	68 60 0a 00 00       	push   $0xa60
  16:	e8 60 03 00 00       	call   37b <getpinfo>
  if (x < 0)
  1b:	83 c4 10             	add    $0x10,%esp
  1e:	85 c0                	test   %eax,%eax
  20:	78 39                	js     5b <main+0x5b>
  {
    exit();
  }
  // Create three child processes with different numbers of tickets
  int pid_A = fork();
  22:	e8 a4 02 00 00       	call   2cb <fork>
  if (pid_A == 0) {
  27:	85 c0                	test   %eax,%eax
  29:	75 0f                	jne    3a <main+0x3a>
    settickets(30);
  2b:	83 ec 0c             	sub    $0xc,%esp
  2e:	6a 1e                	push   $0x1e
  30:	e8 3e 03 00 00       	call   373 <settickets>
  ...
  int pid_B = fork();
  3a:	e8 8c 02 00 00       	call   2cb <fork>
  if (pid_B == 0) {
  3f:	85 c0                	test   %eax,%eax
  41:	74 1d                	je     60 <main+0x60>
    settickets(20);
    process();
  }

  int pid_C = fork();
  43:	e8 83 02 00 00       	call   2cb <fork>
  if (pid_C == 0) {
  ...
  for (i = 0; i < 3; i++) {
    wait();
  4c:	e8 8a 02 00 00       	call   2db <wait>
  51:	e8 85 02 00 00       	call   2db <wait>
  56:	e8 80 02 00 00       	call   2db <wait>
  }
  ...
  63:	6a 14                	push   $0x14
  65:	e8 09 03 00 00       	call   373 <settickets>
  6a:	83 c4 10             	add    $0x10,%esp
  6d:	eb fe                	jmp    6d <main+0x6d>
    settickets(10);
  6f:	83 ec 0c             	sub    $0xc,%esp
  72:	6a 0a                	push   $0xa
  74:	e8 fa 02 00 00       	call   373 <settickets>
  79:	83 c4 10             	add    $0x10,%esp
  7c:	eb fe                	jmp    7c <main+0x7c>
  7e:	66 90                	xchg   %ax,%ax

00000080 <process>:
  while (1) {
  80:	eb fe                	jmp    80 <process>
  82:	66 90                	xchg   %ax,%ax
  84:	66 90                	xchg   %ax,%ax
  86:	66 90                	xchg   %ax,%ax
  88:	66 90                	xchg   %ax,%ax
 ...
 398:	89 d1                	mov    %edx,%ecx
{
 ...
 3cb:	0f b6 92 98 07 00 00 	movzbl 0x798(%edx),%edx
 ...
 439:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4a4:	ff 24 85 40 07 00 00 	jmp    *0x740(,%eax,4)
 ...
 5b0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5b5:	bb 38 07 00 00       	mov    $0x738,%ebx
...
free(void *ap)
{
 ...
 5c1:	a1 60 0e 00 00       	mov    0xe60,%eax
{
 ...
 5ff:	5b                   	pop    %ebx
  freep = p;
 600:	a3 60 0e 00 00       	mov    %eax,0xe60
}
 605:	5e                   	pop    %esi
 606:	5f                   	pop    %edi
 607:	5d                   	pop    %ebp
 ...
 616:	72 ce                	jb     5e6 <free+0x26>
{
 ...
 637:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 63a:	a3 60 0e 00 00       	mov    %eax,0xe60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 15 60 0e 00 00    	mov    0xe60,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69b:	3b 05 60 0e 00 00    	cmp    0xe60,%eax
 ...
 6be:	e8 fd fe ff ff       	call   5c0 <free>
  return freep;
 6c3:	8b 15 60 0e 00 00    	mov    0xe60,%edx
 ...
 6ec:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6ef:	89 15 60 0e 00 00    	mov    %edx,0xe60
}
 ...
 6ff:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 700:	c7 05 60 0e 00 00 64 	movl   $0xe64,0xe60
 707:	0e 00 00 
    base.s.size = 0;
 70a:	b8 64 0e 00 00       	mov    $0xe64,%eax
    base.s.ptr = freep = prevp = &base;
 70f:	c7 05 64 0e 00 00 64 	movl   $0xe64,0xe64
 716:	0e 00 00 
    base.s.size = 0;
 719:	c7 05 68 0e 00 00 00 	movl   $0x0,0xe68
 720:	00 00 00 
    if(p->s.size >= nunits){
